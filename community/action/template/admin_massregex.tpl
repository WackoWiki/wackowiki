[ === main === ]
	...
	[= search _ =
		<form action="[ ' href: ' ]" method="post" name="select_pages">
			[ ' csrf: select_pages ' ]
			<label for="target_pages">[ ' _t: UsersPages ' ]</label><br>
			<textarea id="target_pages" name="pages" class="cols-100" cols="100" rows="5">[ ' pages | pre ' ]</textarea><br>
			<br>
			<table>
				<tbody>
					<tr>
						<td>
							...
							<textarea id="text_target" name="target" class="cols-100" cols="100" rows="5">[ ' target | pre ' ]</textarea>
						</td>
						<td>
							<label for="text_replacement">[ ' _t: TextReplacement ' ]</label><br>
							<textarea id="text_replacement" name="replacement" class="cols-100" cols="100" rows="5">[ ' replacement | pre ' ]</textarea>
						</td>
					</tr>
				</tbody>
			</table>
