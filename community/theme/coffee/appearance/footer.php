...
if ($this->page)
{
	if ($this->has_access('read'))
	{
		...
		if ($this->is_owner())
		{
			...
			(($this->method == 'new')
				? ""
				: print("<li><a href=\"".$this->href('new')."\"><img src=\"".$this->config['theme_url']."icon/add_page.png\" title=\"".$this->_t('CreateNewPageTip')."\" alt=\"".$this->_t('CreateNewPageTip')."\" /></a></li>\n")
			);
			...
			if (!$this->config['remove_onlyadmins']) print("<li><a href=\"".$this->href('remove')."\"><img src=\"".$this->config['theme_url']."icon/delete_page.png\" title=\"".$this->_t('DeleteTip')."\" alt=\"".$this->_t('DeleteText')."\" /></a></li>\n");
		...
		{
			print("<li><a href=\"".$this->href('remove')."\"><img src=\"".$this->config['theme_url']."icon/delete_page.png\" title=\"".$this->_t('DeleteTip')."\" alt=\"".$this->_t('DeleteText')."\" /></a></li>\n");
