...
<div class="header">
	<h1>
  <?php echo file_exists("images/".$this->db->site_name.".png")?"<img src='/images/".$this->db->site_name.".png' alt='".$this->db->site_name."' />":$this->db->site_name ?> : <?php echo isset($this->page['title']) ? $this->page['title'] : $this->tag; ?>
	</h1>
</div>