...
<div id="page"><div class="header">
  <h1>
  <?php echo file_exists("image/".$this->config['site_name'].".png")?"<img src='/image/".$this->config['site_name'].".png' alt='".$this->config['site_name']."' />":$this->config["site_name"] ?> : <?php echo $this->tag ?>
  </h1>
</div>
