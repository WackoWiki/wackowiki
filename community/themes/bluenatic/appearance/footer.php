...
&nbsp;|&nbsp; <?php // Check if page has an owner - if not, add the claim text ?>
	<?php if($owner = $this->GetPageOwner()) {
		...
		echo $this->GetResourceValue("Nobody"); ?> <a
	href="<?php echo $this->href("claim"); ?>"><?php echo $this->GetResourceValue("TakeOwnership"); ?></a>
		<?php } ?> &nbsp;|&nbsp; <a
	href="<?php echo $this->href("settings"); ?>"><?php echo $this->GetResourceValue("SettingsText"); ?></a>
&nbsp;|&nbsp; <?php // Watch page ?> <a
...
<img
	...
	alt="<?php echo $this->GetResourceValue("RemoveWatch"); ?>"
	title="<?php echo $this->GetResourceValue("RemoveWatch"); ?>"
	width="16" height="16" /> <?php } else { ?> <img
	src="<?php echo $this->GetConfigValue("theme_url"); ?>images/watch-add.gif"
	alt="<?php echo $this->GetResourceValue("SetWatch"); ?>"
	title="<?php echo $this->GetResourceValue("SetWatch"); ?>" width="16"
...
<a href="<?php echo $this->Href('', '', "removebookmark=yes"); ?>"> <img
	...
	alt="<?php echo $this->GetResourceValue("RemoveFromBookmarks"); ?>"
