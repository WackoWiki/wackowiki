...
?>
  ...
  <div id="infomenu">
    <div id="breadcrumb">
      <!-- <h1>-->
      <span class="main"><a href="<?php echo $this->GetConfigValue("base_url"); ?>"><?php echo $this->config["wakka_name"] ?></a>:</span> <span class="pagetitle"><?php echo $this->GetPagePath(); ?></span> <a class="Search" title="<?php echo $this->GetConfigValue("search_title_help")?>" 
