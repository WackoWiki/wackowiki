...
<body onload="all_init();<?php if($message) echo "alert('".$message."');"; ?>">
	<div id="mainwrapper">
		<div id="header">
			...
			<a title="<?php echo $this->GetConfigValue("search_title_help"); ?>" href="<?php echo $this->config["base_url"].$this->GetResourceValue("TextSearchPage").($this->config["rewrite_mode"] ? "?" : "&amp;"); ?>phrase=<?php echo urlencode($this->GetPageTag()); ?>">...</a> 
		</div>
		<div id="quicklinks">
			<div class="bookmarks">
