...
<head>
<title><?php echo htmlspecialchars($this->config['wacko_name'])." : ".$this->add_spaces($this->tag).($this->method!="show"?" (".$this->method.")":""); ?>
</title>
<?php
				...
				<table class="navOpened" id="sw_n1" align="center" cellpadding="0"
					...
					<tr>
						...
						if ($this->page) {
							...
							echo '<br />';
							print("<a href=\"".$this->href("settings"). "\"".(($this->method=='edit')?" onclick=\"return window.confirm('".$this->get_translation("EditACLConfirm")."');\"":"")."\"><img src=\"".$this->config['theme_url']."icons/prop.gif\""."style=\"vertical-align: middle\"".">".$this->get_translation("SettingsText")."</a>");
