...
<link rel="alternate" type="application/rss+xml" title="Letzte Änderungen als RSS" href="<?php echo $this->GetConfigValue("root_url");?>xml/recentchanges_<?php echo preg_replace("/[^a-zA-Z0-9]/", "", strtolower($this->GetConfigValue("wakka_name")));?>.xml" />
<link rel="alternate" type="application/rss+xml" title="Letzte Änderung von <?php echo $this->tag; ?> als RSS" href="<?php echo $this->href("revisions.xml");?>" />
<?php 
// Three JS files.
...
?></td>
  ...
  <tr bgcolor="#85a43c">
    <td height="20" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div class="navText"><strong><?php echo $this->ComposeLinkToPage($this->config["root_page"]);?>:</strong> <?php echo $this->GetPagePath(); ?> <a title="<?php echo $this->GetResourceValue("SearchTitleHelp")?>" 
