...
if ($this->get_user()) { ?>
  ...
  <small>
  <?php
      echo $this->compose_link_to_page($this->get_translation("YouArePanelLink"), "", $this->get_translation("YouArePanelAccount"), 0); ?><br />
...
?><br />
  <?php
// Watch/Unwatch icon
echo ($this->iswatched === true ? "<a href=\"".$this->href("watch")."\">".$this->get_translation("RemoveWatch")."</a>" : "<a href=\"".$this->href("watch")."\">".$this->get_translation("set_watch")."</a>" );
?><br />
  <?php
 // Rename link
