		...
		<div class="sitesuffix">
			...
			<div class="pagetools">
				...
				<ul>
					...
					<?php /* Watch/Unwatch icon */ if ($this->get_user()) {echo ($this->iswatched === true ? '<li id="page_unwatch"><a href="'.$this->href("watch").'" title="'.$this->get_translation("RemoveWatch").'"><span class="backendbutton"></span><img class="contexticon" src="'.$this->config['theme_url'].'icons/transmit_delete.png" alt="" />'.$this->get_translation("RemoveWatch").'</a><span class="sep">,</span></li>' : '<li id="page_watch"><a href="'.$this->href("watch").'" title="'.$this->get_translation("set_watch").'"><span class="backendbutton"></span><img class="contexticon" src="'.$this->config['theme_url'].'icons/transmit_add.png" alt="" />'.$this->get_translation("set_watch").'</a><span class="sep">,</span></li>')."\n";} ?>
