		...
		<div class="sitesuffix">
			...
			<div class="pagetools">
				...
				<ul>
					...
					<?php /* Edit ACLs link */ echo ($this->page && $this->GetUser() && $this->UserIsOwner()) ? '<li id="page_acls"><a href="'.$this->href("acls").'"'.(($this->method=='edit')?" onclick=\"return window.confirm('".$this->GetTranslation("EditACLConfirm")."');\"":"").' title="'.$this->GetTranslation("EditACLText").'"><span class="backendbutton"></span><img class="contexticon" src="'.$this->config["theme_url"].'icons/page_key.png" alt="" />'.$this->GetTranslation("EditACLText").'</a><span class="sep">,</span></li>'."\n" : ''; ?>
