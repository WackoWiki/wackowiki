		...
		<div class="sitesuffix">
			...
			<div class="pagetools">
				...
				<ul>
					...
					<?php /* Page properties link */ if ($this->GetUser()) {print '<li id="page_properties"><a href="'.$this->href("properties").'"'.(($this->method=='edit')?" onclick=\"return window.confirm('".$this->GetTranslation("EditACLConfirm")."');\"":"").' title="'.$this->GetTranslation("PropertiesTip").'"><span class="backendbutton"></span><img class="contexticon" src="'.$this->config["theme_url"].'icons/page_gear.png" alt="" />'.$this->GetTranslation("PropertiesText").'</a><span class="sep">,</span></li>'."\n";} ?>
