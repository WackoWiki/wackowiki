		...
		<div class="sitesuffix">
			...
			<div class="pagetools">
				...
				<ul>
					...
					<?php /* Page settings link */ if ($this->GetUser()) {print '<li id="page_settings"><a href="'.$this->href("properties").'"'.(($this->method=='edit')?" onclick=\"return window.confirm('".$this->GetTranslation("EditACLConfirm")."');\"":"").' title="'.$this->GetTranslation("SettingsTip").'"><span class="backendbutton"></span><img class="contexticon" src="'.$this->config["theme_url"].'icons/page_gear.png" alt="" />'.$this->GetTranslation("SettingsText").'</a><span class="sep">,</span></li>'."\n";} ?>
