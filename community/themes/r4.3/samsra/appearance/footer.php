...
if ($this->page)
{
 ...
 if ($this->user_is_owner())
 {
   ...
   // Rename link
   print(" <a href=\"".$this->href("rename")."\"><img src=\"".$this->config['theme_url']."icons/rename.gif\" title=\"".$this->get_translation("RenameText")."\" alt=\"".$this->get_translation("RenameText")."\" /></a>");
//   if (!$this->config['remove_onlyadmins'] || $this->is_admin()) print(" <a href=\"".$this->href("remove")."\"><img src=\"".$this->config['theme_url']."icons/delete.gif\" title=\"".$this->get_translation("DeleteTip")."\" alt=\"".$this->get_translation("DeleteText")."\" /></a>");
 ...
 if ($this->is_admin())
 {
   print(" <a href=\"".$this->href("remove")."\"><img src=\"".$this->config['theme_url']."icons/delete.gif\" title=\"".$this->get_translation("DeleteTip")."\" alt=\"".$this->get_translation("DeleteText")."\" /></a>");
 }
...
print("<a href=\"".$this->href("referrers")."\"><img src=\"".$this->config['theme_url']."icons/referer.gif\" title=\"".$this->get_translation("ReferrersTip")."\" alt=\"".$this->get_translation("ReferrersText")."\" /></a> |");
}
?>
<?php
// Watch/Unwatch icon
...
<?php
// Print icon
echo"<a href=\"".$this->href("print")."\" target=\"_new\"><img src=\"".$this->config['theme_url']."icons/print.gif\" title=\"".$this->get_translation("PrintVersion")."\" alt=\"".$this->get_translation("PrintVersion")."\" /></a>";
?>
