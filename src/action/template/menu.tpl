[ === menu === ]
	...
	[= bm _ =
		<form action="[ ' href: ' ]" method="post" name="edit_bookmarks">
			...
			[= lang _ =
				[ ' select ' ]
				<button type="submit" class="btn btn-primary" name="update" id="submit">[ ' _t: UpdateButton ' ]</button>
				<br><br>
			=]
	...
	<form action="[ ' href: ' ]" method="post" name="add_bookmark">
		...
		=]
		<button type="submit" class="btn btn-success" name="add_menu_item">[ ' _t: CreateButton ' ]</button>
	</form>
