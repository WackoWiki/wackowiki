...
{
	$this->add_html('footer', '<script src="' . $this->db->base_path . 'js/core/helpers.js" defer></script>');
	$this->add_html('footer', '<script src="' . $this->db->base_path . Ut::join_path('js/lang/', 'wikiedit.' . $this->user_lang . '.js') . '" defer></script>');
	$this->add_html('footer', '<script src="' . $this->db->base_path . 'js/components/upload.js" defer></script>');
