...
$ap_translation = [
	...
	'CommentsOffset'			=> 'صفحة التعليقات:',
	'CommentsOffsetInfo'		=> 'صفحة التعليقات لعرضها بشكل افتراضي',
	...
	'X11colorsInfo'				=> 'يوسع الألوان المتاحة ل <code>??(اللون) الخلفية؟??</code> و <code>!!(اللون) نص اللون!!</code>تعطيل هذا الخيار يؤدي إلى تسريع عمليات إضافة التعليقات وحفظ الصفحات.',
	...
	'AmericanDate'					=> 'التاريخ الأمريكي:',
	'AmericanDateInfo'				=> 'يستخدم تنسيق تاريخ الأمريكان كإفتراضي للإنجليزية.',
	...
	'WhatsNewPage'				=> 'ما الجديد:',
	'WhatsNewPageInfo'			=> 'صفحة تحتوي على قائمة بجميع الصفحات الجديدة أو المحذوفة أو المتغيرة، والمرفقات الجديدة، والتعليقات (الإجراء %1).',
	...
	'LogUserPasswordReset'		=> 'تم إعادة تعيين كلمة المرور للمستخدم ##%1## بنجاح',
