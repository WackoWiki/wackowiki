...
$ap_translation = [
  ...
  <span class="cite">Værdien kan blive overskrevet af klassen Indstillinger under kørsel, uanset om den er slået fra, hvis HTTP_MOD_REWRITE er slået til.',
	...
	'BackupCompleted'			=> 'Sikkerhedskopiering og arkivering fuldført.<br>' .
    	'Backup-pakkefilerne blev gemt i undermappen %1.<br>For at downloade det bruge FTP (vedligeholde mappestruktur og filnavne ved kopiering).<br> For at gendanne en sikkerhedskopi eller fjerne en pakke, gå til <a href="%2">Gendan database</a>.',
