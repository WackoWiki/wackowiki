...
$ap_translation = [
	...
	'NoRecoveryPasswordTip'		=> 'Hinweis: Das Fehlen eines Administrator-Passworts ist eine Bedrohung für die Sicherheit! Gib den Passwort-Hash in der Konfigurationsdatei an und starte das Programm erneut.',
	...
	'SectionEditInfo'			=> 'Ermöglicht die Bearbeitung nur eines Abschnitts einer Seite.',
	...
	'ResetUserTheme'			=> 'Alle Benutzerthemen zurücksetzen:',
	'ResetUserThemeInfo'		=> 'Alle Benutzerthemen zurücksetzen. Warnung: Diese Aktion wird alle vom Benutzer ausgewählten Themes auf das globale Standardthema zurücksetzen.',
	'SetBackUserTheme'			=> 'Alle Benutzerthemen auf das %1 Theme zurücksetzen.',
	...
	'ForbiddenEmailDomainsInfo'	=> 'Nicht gestattete E-Mail-Domänen durch Komma getrennt, e.g. <code>example.com, local.lan</code> usw. (nur wirksam, wenn die Liste der erlaubten E-Mail-Domänen leer ist)',
	...
	'AmericanDate'					=> 'Amerikanisches Datum:',
	'AmericanDateInfo'				=> 'Verwendet amerikanisches Datumsformat als Standard für Englisch.',
	...
	'WhatsNewPage'				=> 'Was ist neu:',
	'WhatsNewPageInfo'			=> 'Seite mit einer Liste aller neuen, gelöschten oder geänderten Seiten, neuer Anhänge und Kommentare. (Aktion %1).',
	...
	'EmailSubjectPrefixInfo'	=> 'Alternativer E-Mail-Betreff-Prefix, e.g. <code>[Prefix] Betreff</code>. Wenn nicht definiert, lautet das Standardpräfix Site Name: %1.',
	...
	'JpegQualityInfo'			=> 'Qualität beim Skalieren einer JPEG-Miniaturansicht. Sie sollte zwischen 1 und 100 liegen, wobei 100 für 100 % Qualität steht.',
	'MaxImageArea'				=> 'Maximum Image Area:',
	'MaxImageAreaInfo'			=> 'Die maximale Anzahl von Pixeln, die ein Quellbild haben kann. Damit wird die Speichernutzung für die Dekomprimierungsseite des Bildskalierers begrenzt. <br><code>-1</code> bedeutet, dass die Größe des Bildes nicht überprüft wird, bevor versucht wird, es zu skalieren. <code>0</code> bedeutet, dass der Wert automatisch ermittelt wird.',
	...
	'LogUserPasswordReset'		=> 'Passwort für Benutzer ##%1## erfolgreich zurückgesetzt',
	...
	'RestoreFile'				=> 'Datei:',
	'RestoredFiles'				=> 'wiederhergestellt:',
	'SkippedFiles'				=> 'übersprungen:',
	...
	// --> Settings
	'BbSettingsUpdated'			=> 'Einstellungen von Bad Behaviour geändert',
