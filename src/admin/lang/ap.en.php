...
$ap_translation = [
	...
	'AllowedUploadExtsInfo'		=> 'Allowed extensions comma separated for uploading files, e.g. <code>png, ogg, mp4</code>, other wise all not prohibited file extensions are allowed.<br>The file types allowed to be uploaded should be restricted to only those that are necessary.',
