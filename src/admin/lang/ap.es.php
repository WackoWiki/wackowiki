...
$ap_translation = [
	...
	'SectionEdit'				=> 'Edición de sección:',
	'SectionEditInfo'			=> 'Permite editar sólo una sección de una página.',
	...
	'LoginNoticeInfo'				=> 'Muestra un aviso de inicio de sesión.',
	...
	'ForbiddenEmailDomainsInfo'	=> 'Dominios de correo electrónico prohibidos separados por comas, por ejemplo <code>example.com, local.lan</code> etc. (sólo es efectivo si la lista de dominios de correo electrónico permitidos está vacía)',
	...
	'AmericanDate'					=> 'Fecha americana:',
	'AmericanDateInfo'				=> 'Utiliza el formato de fecha del idioma como predeterminado para el inglés.',
	...
	'WhatsNewPage'				=> 'Novedades:',
	'WhatsNewPageInfo'			=> 'Página con una lista de todas las páginas nuevas, eliminadas o modificadas, nuevos archivos adjuntos y comentarios. (acción %1).',
	...
	'AllowedUploadExtsInfo'		=> 'Extensiones permitidas para subir archivos, separadas por comas, por ejemplo <code>png, ogg, mp4</code>, por lo demás se permiten todas las extensiones de archivo no prohibidas.<br>Debe limitar la lista de tipos de archivos cargados permitidos al mínimo necesario para la funcionalidad del contenido de su sitio.',
	...
	'JpegQualityInfo'			=> 'Calidad al escalar una miniatura JPEG. Debe estar entre 1 y 100, con 100 indicando 100% de calidad.',
	'MaxImageArea'				=> 'Maximum Image Area:',
	'MaxImageAreaInfo'			=> 'El número máximo de píxeles que puede tener una imagen de origen. Esto proporciona un límite en el uso de memoria para el lado de descompresión del escalador de imágenes. <br><code>-1</code> significa que no comprobará el tamaño de la imagen antes de intentar escalarla. <code>0</code> significa que determinará el valor automáticamente.',
	...
	'LogUserPasswordReset'		=> 'Contraseña para el usuario ##%1## restablecida con éxito',
	...
	'RestoreFile'				=> 'Archivo:',
	'RestoredFiles'				=> 'restaurada:',
	'SkippedFiles'				=> 'omitida:',
