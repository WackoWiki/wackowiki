...
questi, ovvero se la richiesta raggiunge il server web da uno dei tuoi proxy inversi. Altrimenti, il client potrebbe connettersi direttamente al tuo server web falsificando le intestazioni X-Forwarded-For.',
	...
	'WhatsNewPage'				=> 'Cosa c\'è di nuovo:',
	'WhatsNewPageInfo'			=> 'Pagina con un elenco di tutte le pagine nuove, cancellate o modificate, nuovi allegati e commenti. (azione %1).',
	...
	'BackupCompleted'			=> 'Backup e archiviazione completati.<br>' .
    	'I file dei pacchetti di backup sono stati memorizzati nella sottodirectory %1.<br>Per scaricarlo usa FTP (mantieni la struttura della directory e i nomi dei file durante la copia).<br> Per ripristinare una copia di backup o rimuovere un pacchetto, vai su <a href="%2">Ripristina database</a>.',
