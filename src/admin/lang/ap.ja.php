...
$ap_translation = [
	...
	'CommentsOffset'			=> 'コメントページ:',
	'CommentsOffsetInfo'		=> 'デフォルトで表示されるコメントページ',
	...
	'WhatsNewPage'				=> '新着情報:',
	'WhatsNewPageInfo'			=> '新規ページ、削除または変更されたページ、新しい添付ファイル、コメントの一覧が表示されます。 (アクション %1)。',
	'ChangesPage'				=> '最近の変更:',
