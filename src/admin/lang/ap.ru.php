...
$ap_translation = [
    ...
    'ReverseProxyInfo'			=> 
    'Включите эту настройку для определения правильного IP-адреса удаленного клиента по информации хранящейся в заголовках X-Forwarded-For. Заголовки X-Forwarded-For являются стандартным механизмом идентификации клиентов подключающихся через обратный прокси сервер, например Squid или Pound. Обратные прокси серверы часто используются для повышения производительности нагруженных сайтов, а также может обеспечить кэширование сайтов, улучшение безопасности или шифрования. Если ваш сайт WackoWiki работает за обратным прокси-сервером эта настройка должна быть включена, чтобы информация об IP адресе правильно зафиксировалась в логах WackoWiki для регистрации, статистики и систем управления доступом. Если вы не уверены что сервер не использует обратный прокси этот параметр должен быть отключен.',
