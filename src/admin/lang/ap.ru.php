...
$ap_translation = [
	...
	'BackupCompleted'			=> 'Резервное копирование и архивация завершены.<br>' .
    	'Файлы пакетов резервного копирования были сохранены в подкаталоге %1.<br>Для загрузки используйте FTP (поддерживайте структуру каталогов и имена файлов при копировании).<br> Для восстановления резервной копии или удаления пакета перейдите в <a href="%2">Восстановление базы данных</a>.',
	...
	'DbEngineInvalid'			=> 'Недопустимый движок базы данных, ожидается %1',
	...
	'SQLiteDatabaseRestored'	=> 'База данных успешно восстановлена из:',
