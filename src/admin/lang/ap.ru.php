...
$ap_translation = [
	...
	'AllowedUploadExtsInfo'		=> 'Разрешенные расширения для загрузки файлов, через запятую, например, <code>png, ogg, mp4</code>, в остальных случаях разрешены все не запрещенные расширения файлов.',
