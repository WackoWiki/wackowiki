...
$ap_translation = [
	...
	'AmericanDate'					=> '美國日期：',
	'AmericanDateInfo'				=> '使用美國日期格式作為英文的預設格式。',
	...
	'WhatsNewPageInfo'			=> '包含所有新增、刪除或變更的頁面、新增附件和評論的清單頁面。 （操作 %1）。',
	'ChangesPage'				=> '近期變動:',
	...
	'BackupCompleted'			=> 'Backing up and archiving completed.<br>' .
    	'備份包檔案儲存在子目錄 %1 中。 <br>要下載它，請使用 FTP（複製時請保持目錄結構和檔案名稱不變）。 <br>要恢復備份副本或刪除軟體包，請前往<a href="%2">恢復資料庫</a>。',
	...
	'SQLiteDatabaseRestored'	=> '資料庫已成功從以下位置復原：',
