...
$ap_translation = [
	...
	'SectionEdit'				=> '节段编辑：',
	'SectionEditInfo'			=> '只允许编辑一个页面的某个部分。',
	'ReviewSettings'			=> '审查：',
	...
	'WhatsNewPage'				=> '新鲜事物：',
	'WhatsNewPageInfo'			=> '包含所有新的、删除的或更改的页面、新的附件和评论列表的页面(操作 %1)。',
	'ChangesPage'				=> '动态：',
	...
	'AllowedUploadExtsInfo'		=> '允许上传文件的扩展名，用逗号分隔，例如：<code>png, ogg, mp4</code>，其他情况下，所有不被禁止的文件扩展名都被允许。<br>你应该把允许上传的文件类型限制在你的网站内容功能所需的最低限度。',
	...
	'JpegQuality'				=> 'JPEG质量：',
	'JpegQualityInfo'			=> '缩放JPEG缩略图时的质量。它应该在1到100之间，100表示100%的质量。',
	'MaxImageArea'				=> 'Maximum Image Area:',
	'MaxImageAreaInfo'			=> '一个源图像可以有的最大像素数。这为图像缩放器的解压部分提供了一个内存使用限制。<br><code>-1</code>表示在尝试缩放之前，它不会检查图像的大小。<code>0</code>表示它将自动确定该值。',
