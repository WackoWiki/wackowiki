...
<?php
	...
	if (isset($_POST['create_group']))
	{
		...
		echo '<table class="formation lined">
				<tr>
					...
					<td>
						<input type="text" id="new_group_name" name="new_group_name" value="' . Ut::html(($_POST['new_group_name'] ?? '')) . '" pattern="' . $engine->lang['USER_NAME'] . '" size="20" maxlength="100">
					</td>
				</tr>
				<tr>
					<th>
	...
	// edit group
	else if (isset($_POST['edit_group']) && isset($_POST['change']))
	{
	...
	// delete group
	else if (isset($_POST['delete_group']) && isset($_POST['change']))
	{
		if ($usergroup = $engine->db->load_single(
