...
<form action="[' href ']" method="post" name="clone_page" >
	...
	<input type="text" id="clone_name" name="clone_name" size="40" maxlength="250" placeholder="[' placeholder | e attr ']" required>
	[' e editNote ']
	[' doCluster ']
	<br><br>
	<button type="submit" class="btn btn-primary" name="submit">[' _t: CloneButton ']</button>
	&nbsp;
	<a href="[' show ']" class="btn-link"><button type="button" class="btn btn-cancel">[' _t: CancelButton | replace "\n" " " ']</button></a>
</form>
[ ====================================== editNote =================================== ]
<br>
