...
$wacko_all_resource = [
	// link templates
	'Tpl.page'			=> '<a{aname} href="{pagelink}"{rel}{class}>{accicon}{icon}{page}</a>',
	...
	'Tpl.wpage'			=> '<span class="missingpage">{icon}{page}</span><a href="{pagelink}" title="{title}">{accicon}</a>',
	...
	'Tpl.pwpage'		=> '<span class="missingpage">{icon}{page}</span>',
