...
$wacko_translation = [
	...
	'ZenMode'					=> 'По умолчанию включить отвлекающую запись',
	'WidescreenMode'			=> 'По умолчанию использовать широкоэкранный редактор',
	'EditorInterface'			=> 'Интерфейс редактора',
	...
	'DropFilesHere'				=> 'Перетащите файлы сюда, чтобы загрузить',
	...
	'SubpagesRenaming'			=> 'Переименовать выбранные подстраницы',
	'RenameSubpagesOnly'		=> 'Переименовать только выбранные подстраницы',
	...
	'ModerateConvertToPage'		=> 'Преобразовать в страницу',
	'ModerateConvertConfirm'	=> 'Преобразовать комментарий в страницу',
	'ModerateReassignFollowing'	=> 'Переназначить все следующие комментарии на новую страницу',
	'ModerateCommentConverted'	=> 'Выбранный комментарий преобразован в страницу.',
	...
	'LogCommentConvertedToPage'	=> 'Комментарий [[/%1]] преобразован в страницу [[/%2]]',
