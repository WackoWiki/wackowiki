...
$wacko_translation = [
	...
	'ReplaceTextNoDifference'	=> 'Нет никакой разницы между заменяемым и целевым текстом.',
	...
	'ReplaceTextSuccess'		=> '%1 был заменен на %2 на %3 страницах.',
	...
	'ReplaceTextWarning'		=> 'Внимание. Найдена %1 страниц, содержащих текст для замены, %2. Если вы продолжите операцию замены, то не сможете отделить уже существующие записи от тех, которые появятся после замены.',
