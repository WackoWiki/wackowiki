...
$insert_logo_image			= "INSERT INTO {$pref}file (page_id, user_id, file_name, file_lang, file_description, uploaded_dt, modified_dt, file_size, picture_w, picture_h, file_ext, mime_type) VALUES ('0', (SELECT user_id FROM {$pref}user WHERE user_name = '" . $config['admin_name'] . "' LIMIT 1), 'wacko_logo.png', '" . $config['language'] . "', 'WackoWiki', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1580', '108', '50', 'png', 'image/png')";
