...
$upgrade['6.0.30'][]	= ['alter',		'cache',			$alter_cache_r5_5_2];
...
$upgrade['6.0.36'][]	= ['alter',		'file',				$alter_file_r6_0_5];
$upgrade['6.0.36'][]	= ['alter',		'file',				$alter_file_r6_0_6];
...
$upgrade['6.0.32'][]	= ['update',	'page',				$update_page_r5_5_0];
