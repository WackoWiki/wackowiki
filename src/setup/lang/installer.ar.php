...
'AclMode'						=> 'إعدادات ACL الافتراضية',
'AclModeDesc'					=> '',
'PublicWiki'					=> 'الويكي العام (القراءة للجميع، والكتابة والتعليق للمستخدمين المسجلين)',
'PrivateWiki'					=> 'ويكي خاص (للقراءة والكتابة والتعليق على المستخدمين المسجلين فقط)',
'Admin'							=> 'اسم المشرف',
