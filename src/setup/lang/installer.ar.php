...
'ErrorMinPhpVersion'			=> 'يجب أن يكون إصدار PHP أكبر من <strong>' . PHP_MIN_VERSION . '</strong>. يبدو أن الخادم الخاص بك يقوم بتشغيل إصدار سابق. يجب عليك الترقية إلى إصدار PHP أحدث لWackoWiki للعمل بشكل صحيح.',
...
'Base'							=> 'الرابط الأساسي',
'BaseDesc'						=> 'رابط قاعدة موقع WackoWiki الخاص بك. يتم إرفاق أسماء الصفحات بها، لذا إذا كنت تستخدم mod_rewrite ، يجب أن ينتهي العنوان ببطء إلى الأمام، i. .</p><ul><li><strong><code>https://example. om/</code></strong></li><li><strong><code>https://example.com/wiki/</code></strong></li></ul>',
