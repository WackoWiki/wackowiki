...
'LockAuthorizationInfo'			=> 'Παρακαλώ εισάγετε τον κωδικό πρόσβασης που αποθηκεύσατε στο αρχείο %1.',
...
'EmptyAuthFile'					=> 'Λείπει ή κενό αρχείο %1 . Παρακαλώ δημιουργήστε το αρχείο και ορίστε έναν κωδικό πρόσβασης σε αυτό το αρχείο.',
...
'DbNameSqliteHelp'				=> 'Η SQLite αποθηκεύει όλα τα δεδομένα σε ένα μόνο αρχείο.<br><br>Ο κατάλογος που παρέχετε πρέπει να είναι εγγράψιμος από τον διακομιστή ιστού κατά την εγκατάσταση.<br><br>Θα πρέπει να είναι προσβάσιμο <strong>όχι</strong> μέσω του διαδικτύου.<br><br>Ο εγκαταστάτης θα γράψει ένα <code>. taccess</code> αρχείο μαζί με αυτό, αλλά αν αποτύχει κάποιος μπορεί να αποκτήσει πρόσβαση στην ακατέργαστη βάση δεδομένων σας.<br>Περιλαμβάνει ανεπεξέργαστα δεδομένα χρήστη (διευθύνσεις ηλεκτρονικού ταχυδρομείου, κατακερματισμένοι κωδικοί πρόσβασης) καθώς και προστατευμένες σελίδες και άλλα περιορισμένα δεδομένα στο wiki.<br><br>Σκεφτείτε να βάλετε τη βάση δεδομένων κάπου αλλού μαζί, για παράδειγμα σε <code>/var/lib/wackowiki/yourwiki</code>.',
'DbUser'						=> 'Όνομα Χρήστη',
