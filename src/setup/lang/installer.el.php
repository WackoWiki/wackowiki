...
/*
   Locking Check
 */
'LockAuthorization'				=> 'Εξουσιοδότηση',
'LockAuthorizationInfo'			=> 'Παρακαλώ εισάγετε τον κωδικό πρόσβασης που αποθηκεύσατε στο αρχείο %1, τον οποίο τοποθετήσατε προσωρινά στον κατάλογο Wacko.',
'LockPassword'					=> 'Κωδικός:',
'LockLogin'						=> 'Είσοδος',
'LockPasswordInvalid'			=> 'Μη έγκυρος κωδικός πρόσβασης.',
'LockedTryLater'				=> 'Αυτός ο ιστότοπος αναβαθμίζεται. Παρακαλώ δοκιμάστε ξανά αργότερα.',
...
'PleaseUpgradeToR6'				=> 'Εκτελείτε μια παλιά έκδοση του WackoWiki %1. Για να ενημερώσετε σε αυτή τη νέα έκδοση του WackoWiki, πρέπει πρώτα να ενημερώσετε την εγκατάστασή σας σε %2.',
...
'AclMode'						=> 'Προεπιλεγμένες ρυθμίσεις ACL',
'AclModeDesc'					=> '',
'PublicWiki'					=> 'Δημόσιο Wiki (διαβάστε για όλους, γράψτε και σχολιάστε για εγγεγραμμένους χρήστες)',
'PrivateWiki'					=> 'Ιδιωτικό Wiki (διαβασμένο, γράψτε, σχολιάστε μόνο για εγγεγραμμένους χρήστες)',
...
'DbNameSqliteDesc'				=> 'Ο κατάλογος δεδομένων και το όνομα αρχείου SQLite θα πρέπει να χρησιμοποιήσετε για το WackoWiki.',
'DbNameSqliteHelp'				=> 'Η SQLite αποθηκεύει όλα τα δεδομένα σε ένα μόνο αρχείο.<br><br>Ο κατάλογος που θα καθορίσετε πρέπει να είναι εγγράψιμος από το διακομιστή ιστού κατά την εγκατάσταση. <br><br>Θα πρέπει να είναι προσβάσιμο <strong>όχι</strong> μέσω του διαδικτύου.<br><br>Το πρόγραμμα εγκατάστασης θα δημιουργήσει ένα επιπλέον <code>. taccess</code> αρχείο μαζί με το αρχείο, αλλά αν αυτό αποτύχει, κάποιος μπορεί να έχει πρόσβαση στη βάση δεδομένων σας. <br>Αυτό περιλαμβάνει δεδομένα χρήστη (διευθύνσεις ηλεκτρονικού ταχυδρομείου, κατακερματισμένοι κωδικοί πρόσβασης) καθώς και προστατευμένες σελίδες και άλλα εμπιστευτικά δεδομένα που είναι αποθηκευμένα στο wiki. <br><br>Είναι επομένως σκόπιμο να αποθηκεύσετε το αρχείο δεδομένων σε μια εντελώς διαφορετική τοποθεσία, για παράδειγμα στον κατάλογο <code>/var/lib/wackowiki/yourwiki</code>.',
'DbUser'						=> 'Όνομα Χρήστη',
...
'SqliteFileExtensionError'		=> 'Παρακαλούμε χρησιμοποιήστε μία από τις ακόλουθες επεκτάσεις αρχείου db, sdb, sqlite.',
'SqliteParentUnwritableGroup'	=> 'Αδυναμία δημιουργίας του καταλόγου δεδομένων <code>%1</code>, επειδή ο γονικός κατάλογος <code>%2</code> δεν είναι εγγράψιμος από τον διακομιστή web.<br><br>Ο εγκαταστάτης έχει καθορίσει το χρήστη με τον οποίο εκτελείται ο διακομιστής web.<br>Κάνει τον κατάλογο <code>%3</code> εγγράψιμο από αυτό για να συνεχίσει.<br>Σε ένα σύστημα Unix/Linux κάνει:<br><br><pre>cd %2<br>mkdir %3<br>chgrp %4 %3<br>chmod g+w %3</pre>',
'SqliteParentUnwritableNogroup'	=> 'Αδυναμία δημιουργίας του καταλόγου δεδομένων <code>%1</code>, επειδή ο γονικός κατάλογος <code>%2</code> δεν είναι εγγράψιμος από τον διακομιστή web.<br><br>Ο εγκαταστάτης δεν μπόρεσε να καθορίσει το χρήστη που εκτελεί ο διακομιστής web.<br>Κάνε τον κατάλογο <code>%3</code> παγκοσμίως εγγράψιμο από αυτόν (και άλλους!) να συνεχίσει.<br>Σε ένα σύστημα Unix/Linux κάνει:<br><br><pre>cd %2<br>mkdir %3<br>chmod a+w %3</pre>',
'SqliteMkdirError'				=> 'Σφάλμα κατά τη δημιουργία του καταλόγου δεδομένων <code>%1</code>.<br>Ελέγξτε τη θέση και προσπαθήστε ξανά.',
'SqliteDirUnwritable'			=> 'Αδυναμία εγγραφής στον κατάλογο <code>%1</code>.<br>Αλλάξτε τα δικαιώματά του έτσι ώστε ο διακομιστής web να μπορεί να γράψει σε αυτόν και να προσπαθήσει ξανά.',
'SqliteReadonly'				=> 'Το αρχείο <code>%1</code> δεν είναι εγγράψιμο.',
'SqliteCantCreateDb'			=> 'Αδυναμία δημιουργίας αρχείου βάσης δεδομένων <code>%1</code>.',
...
'CreatingIndex'					=> 'Δημιουργία ευρετηρίου %1',
'CreatingTrigger'				=> 'Δημιουργία εναύσματος %1',
'ErrorAlreadyExists'			=> 'Ο %1 υπάρχει ήδη',
'ErrorCreatingTable'			=> 'Σφάλμα κατά την δημιουργία του πίνακα: %1, δεν υπάρχει ήδη;',
'ErrorCreatingIndex'			=> 'Σφάλμα κατά τη δημιουργία του ευρετηρίου %1 , το κάνει ήδη υπάρχει?',
'ErrorCreatingTrigger'			=> 'Σφάλμα κατά τη δημιουργία του %1 trigger, το κάνει ήδη υπάρχει?',
