...
'LockAuthorizationInfo'			=> 'Пожалуйста, введите пароль, который вы сохранили в файле %1, который временно размещен в папке Wacko.',
'LockPassword'					=> 'Пароль:',
'LockLogin'						=> 'Логин',
...
'DbNameSqliteHelp'				=> 'SQLite хранит все данные в одном файле.<br><br>Указанная директория должна быть доступна для записи веб-сервером во время установки. <br><br>Она должна быть <strong>не</strong> доступна через Интернет.<br><br>Программа установки создаст дополнительную <code>. taccess</code> файл вместе с файлом, но если это не удалось, кто-то сможет получить доступ к вашей базе данных. <br>Это включает в себя данные пользователя (адреса электронной почты, хэшированные пароли), а также защищенные страницы и другие конфиденциальные данные, хранящиеся в вики. <br><br>Поэтому рекомендуется хранить файл данных в другом месте, например в каталоге <code>/var/lib/wackowiki/yourwiki</code>.',
