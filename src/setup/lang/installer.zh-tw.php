...
'SqliteFileExtensionError'		=> '請使用以下其中一種檔案副檔名：db、sdb、sqlite。',
'SqliteParentUnwritableGroup'	=> '無法建立資料目錄 <code>%1</code>，因網頁伺服器對該目錄所在的上層目錄 <code>%2</code> 沒有寫入權限。<br><br>安裝程序所使用的身份依據您用來執行網頁伺服器的身份而定，<br>請開啟網頁伺服器對 <code>%3</code> 的寫入權以繼續安裝，<br>在 Unix/Linux 系統可以執行以下指令：<br><br><pre>cd %2<br>mkdir %3<br>chgrp %4 %3<br>chmod g+w %3</pre>',
'SqliteParentUnwritableNogroup'	=> '無法建立資料目錄 %1</code>，因網頁伺服器對該目錄所在的上層目錄 <code>%2</code> 沒有寫入權限。<br><br>安裝程序所使用的身份依據您用來執行網頁伺服器的身份而定，<br>請開啟全部人對 <code>%3</code> 的寫入權以繼續安裝，<br>在 Unix/Linux 系統可以執行以下指令：<br><br><pre>cd %2<br>mkdir %3<br>chmod a+w %3</pre>',
'SqliteMkdirError'				=> '建立資料目錄 <code>%1</code> 時發生錯誤。\n請檢查路徑後再試一次。',
'SqliteDirUnwritable'			=> '無法寫入目錄 <code>%1</code>.<br>請修改該目錄的權限，請開啟網頁伺服器的寫入權限後，再試一次。',
