[ === main === ]
	...
	[= r _ =
		...
		<form action="[ ' form ' ]" method="post" name="register">
			...
			<input type="text" id="user_name" name="user_name" size="25" minlength="[ ' db: username_chars_min ' ]" maxlength="[ ' db: username_chars_max ' ]" value="[ ' username | e attr ' ]" pattern="[ ' pattern ' ]" autocomplete="off" required autofocus></p>
			<p>[ ' only ' ]</p>
