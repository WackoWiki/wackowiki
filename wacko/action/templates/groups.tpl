...
[ === main === ]
	...
	[= p Profile =
		...
		<table>
			...
			<tr class="lined">
				...
				<td><a href="[ ' groupspace | ' ]">[ ' db: groups_page ' ]/[ ' group.group_name ' ]</a></td>
			</tr>
		</table>
	...
	[= l GroupList =
			...
			<tr>
				<td class="label">
					<form action="[ ' href | ' ]" method="get" name="search_group">
						...
						<input type="search" name="group" maxchars="40" size="40" value="[ ' group ' ]" /> ['' '']
		...
		<table style="width:100%; white-space:nowrap; padding-right:20px;">
			...
			[= line _ =
				<tr class="lined">
					<td style="padding-left:5px;"><a href="[ ' profile | ' ]">[ ' group.group_name ' ]</a></td>
