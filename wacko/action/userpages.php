...
{
	$output1 = '<a id="list"></a><h3>'.$this->get_translation('ListMyWatches')."</h3>".
				'<ul class="menu">'."\n";
	...
	if (isset($_GET['mode']) && $_GET['mode'] == 'mypages')
	{
		echo	$output1 .
				...
				$output5 .
				$output6;
		echo '<a id="list"></a><h4>'.$this->get_translation('ListMyPages')."</h3>";
	...
	else if (isset($_GET['mode']) && $_GET['mode'] == 'mywatches')
	{
		...
		$output5 .
		$output6;
		echo '<a id="list"></a><h4>'.$this->get_translation('ListMyWatches')."</h3>";
	...
	else if (!isset($_GET['mode']) || $_GET['mode'] == 'mychangeswatches')
	{
		...
		$output6;
		echo '<a id="list"></a><h4>'.$this->get_translation('ListMyChangesWatches')."</h3>";
	...
	else if (isset($_GET['mode']) && $_GET['mode'] == 'mychanges')
	{
		...
		$output5 .
		$output6;
		echo '<a id="list"></a><h4>'.$this->get_translation('ListMyChanges')."</h3>";
