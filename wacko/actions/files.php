...
if ($can_view)
{
	...
	// load files list
	$files = $this->load_all(
		"SELECT f.upload_id, f.page_id, f.user_id, f.filesize, f.picture_w, f.picture_h, f.file_ext, f.filename, f.description, f.uploaded_dt, u.user_name AS user, f.hits ".
