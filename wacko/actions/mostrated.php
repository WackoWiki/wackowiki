...
if (isset($top))
{
	...
	echo "<div class=\"layout-box\"><p class=\"layout-box\"><span>".$this->GetTranslation('RatingTopPages').":</span></p>\n";
	if ($pages)
	{
		echo '<table>'."\n";
		foreach ($pages as $page)
		{
			echo '<tr class="lined"><td>'.$this->ComposeLinkToPage($page['pagetag'], '', $page['title'], 0).'</td>'.
	...
	{
		echo '<em>'.$this->GetTranslation('RatingNoPagesRated').'</em>'."\n";
	}
	echo "</div>\n";
}
...
if (isset($bottom))
{
	...
	echo "<div class=\"layout-box\"><p class=\"layout-box\"><span>".$this->GetTranslation('RatingBottomPages').":</span></p>\n";
	if ($pages)
	{
		echo '<table>'."\n";
		foreach ($pages as $page)
