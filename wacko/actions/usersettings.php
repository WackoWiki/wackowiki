...
<div class="cssform">
  ...
  <p>
    ...
    <input name="email" value="<?php echo htmlentities($user["email"]) ?>" size="40" />&nbsp;<?php echo $user["email_confirm"] == "" ? '<img src="'.$this->GetConfigValue("root_url").'themes/_common/icons/tick.png" alt="'.$this->GetResourceValue("EmailConfirmed").'" width="20" height="20" />' : '<img src="'.$this->GetConfigValue("root_url").'themes/_common/icons/Warning.png" alt="'.$this->GetResourceValue("Mail.Confirm").'" width="20" height="23" />' ?>
  </p>
  <p>
