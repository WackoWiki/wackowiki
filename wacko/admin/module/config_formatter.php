...
?>
		...
		<table class="formation">
			...
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="default_typografica" name="default_typografica" value="1"<?php echo ( $engine->db->default_typografica ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="paragrafica" name="paragrafica" value="1"<?php echo ( $engine->db->paragrafica ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="allow_rawhtml" name="allow_rawhtml" value="1"<?php echo ( $engine->db->allow_rawhtml ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<tr class="hl_setting">
				...
				<td>
					<input type="radio" id="disable_safehtml_on" name="disable_safehtml" value="0"<?php echo ( !$engine->db->disable_safehtml ? ' checked="checked"' : '' );?> /><label for="disable_safehtml_on">On.</label>
					<input type="radio" id="disable_safehtml_off" name="disable_safehtml" value="1"<?php echo ( $engine->db->disable_safehtml ? ' checked="checked"' : '' );?> /><label for="disable_safehtml_off">Off.</label>
				</td>
			</tr>
			<tr>
				<th colspan="2">
			...
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="allow_x11colors" name="allow_x11colors" value="1"<?php echo ( $engine->db->allow_x11colors ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="disable_tikilinks" name="disable_tikilinks" value="1"<?php echo ( $engine->db->disable_tikilinks ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			...
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="disable_bracketslinks" name="disable_bracketslinks" value="1"<?php echo ( $engine->db->disable_bracketslinks ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<!--<tr class="hl_setting">
				...
				<td><input type="checkbox" id="disable_npjlinks" name="disable_npjlinks" value="1"<?php echo ( $engine->db->disable_npjlinks ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>-->
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="disable_formatters" name="disable_formatters" value="1"<?php echo ( $engine->db->disable_formatters ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr>
				<th colspan="2">
					<br />
		...
		<?php
			...
			<tr class="hl_setting">
				...
				<small></small></td>
				<td>
					<input type="radio" id="dst_off" name="dst" value="0"<?php echo ( $engine->db->dst == 0 ? ' checked="checked"' : '' );?> /><label for="dst_off">Off.</label>
					<input type="radio" id="dst_on" name="dst" value="1"<?php echo ( $engine->db->dst == 1 ? ' checked="checked"' : '' );?> /><label for="dst_on">On.</label>
				</td>
			</tr>
			<tr>
				<th colspan="2">
			...
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="enable_urls_underscores" name="urls_underscores" value="1"<?php echo ( $engine->db->urls_underscores ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="enable_show_spaces" name="show_spaces" value="1"<?php echo ( $engine->db->show_spaces ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
			<tr class="hl_setting">
				...
				<td><input type="checkbox" id="enable_numerate_links" name="numerate_links" value="1"<?php echo ( $engine->db->numerate_links ? ' checked="checked"' : '' );?> /></td>
			</tr>
			<tr class="lined">
				<td colspan="2"></td>
			</tr>
