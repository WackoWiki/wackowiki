	...
	if ($_POST['action'] == 'update')
	{
		$engine->Query(
			"UPDATE {$engine->config['table_prefix']}config SET ".
				"`forum_cluster`		= '".quote(trim((string)$_POST['forum_cluster'], '/'))."', ".
				"`forum_topics`			= '".quote((int)$_POST['forum_topics'])."', ".
				"`forum_posts`			= '".quote((int)$_POST['forum_posts'])."', ".
				"`news_cluster`			= '".quote(trim((string)$_POST['news_cluster'], '/'))."', ".
				"`news_levels`			= '".quote((string)$_POST['news_levels'])."', ".
				"`root_page`			= '".quote(trim((string)$_POST['root_page'], '/'))."', ".
				"`policy_page`			= '".quote(trim((string)$_POST['policy_page'], '/'))."', ".
				"`search_page`			= '".quote(trim((string)$_POST['search_page'], '/'))."', ".
				"`registration_page`	= '".quote(trim((string)$_POST['registration_page'], '/'))."', ".
				"`login_page`			= '".quote(trim((string)$_POST['login_page'], '/'))."', ".
				"`settings_page`		= '".quote(trim((string)$_POST['settings_page'], '/'))."', ".
				"`password_page`		= '".quote(trim((string)$_POST['password_page'], '/'))."', ".
				"`users_page`			= '".quote(trim((string)$_POST['users_page'], '/'))."', ".
				"`groups_page`			= '".quote(trim((string)$_POST['groups_page'], '/'))."', ".
				"`changes_page`			= '".quote(trim((string)$_POST['changes_page'], '/'))."', ".
				"`comments_page`		= '".quote(trim((string)$_POST['comments_page'], '/'))."', ".
				"`removals_page`		= '".quote(trim((string)$_POST['removals_page'], '/'))."', ".
				"`wanted_page`			= '".quote(trim((string)$_POST['wanted_page'], '/'))."', ".
