...
<?php
	...
	$pagination	= $engine->pagination($count['n'], $limit, 'p', 'mode=systemlog&order='.isset($_GET['order']) ? htmlspecialchars($_GET['order'], ENT_COMPAT | ENT_HTML401, $engine->charset) : '', '', 'admin.php');
