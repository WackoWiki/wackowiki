...
$wackoConfig = array(
	...
	"standard_handlers" => "addcomment|categories|claim|clone|diff|edit|latex|msword|new|permissions|print|properties|rate|referrers|referrers_sites|remove|rename|revisions|revisions\.xml|show|watch",
