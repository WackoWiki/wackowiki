...
class typografica
{
	...
	var $glueleft = array( "ðèñ\.", "òàáë\.", "ñì\.", "èì\.", "óë\.", "ïåð\.", "êâ\.", "îôèñ", "îô\.", "ã\." ); // contains some Russian abberviations, also see below (by Freeman)
	...
	{
		$this->wacko = &$wacko;
		$this->Indent1 = "<img src=".$wacko->config["root_url"].$this->Indent1;
		$this->Indent2 = "<img src=".$wacko->config["root_url"].$this->Indent2;
	}
