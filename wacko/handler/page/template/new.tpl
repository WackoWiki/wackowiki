	...
	[ ' dummy | default * // ADD_NO_DIV ' ]<div id="page" class="page">
		...
		[= p _ =
			<form action="[ ' href: new ' ]" method="post" name="sub_page">
				...
				<code>[ ' base ' ]/</code>
				<input type="text" id="create_subpage" name="tag" value="[ ' tag ' ]" size="20" maxlength="255">
		...
		[= c _ =
			<form action="[ ' href: new ' ]" method="post" name="parent_cluster_page">
				...
				<code>[ ' base ' ]/</code>
				<input type="text" id="create_pageparentcluster" name="tag" value="[ ' tag ' ]" size="20" maxlength="255">
		...
		<form action="[ ' href: new ' ]" method="post" name="random_page">
			...
			<input type="text" id="create_randompage" name="tag" value="[ ' tag ' ]" size="60" maxlength="255">
