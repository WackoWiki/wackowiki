...

{
	...
	if ($_POST["preview"])
	{
		...
		<img src="<?php echo $this->GetConfigValue("root_url");?>images/z.gif"
			class="buttonsspacer" alt="" border="0" /> <input name="preview"
			class="OkBtn" onmouseover='this.className="OkBtn_";'
			onmouseout='this.className="OkBtn";' type="submit" align="top"
			value="<?php echo $this->GetResourceValue("EditPreviewButton"); ?>" />
		<img src="<?php echo $this->GetConfigValue("root_url");?>images/z.gif"
			class="buttonsspacer" alt="" border="0" /> <input class="CancelBtn"
...
?> <input name="save" class="OkBtn_Top"
		...
		<img src="<?php echo $this->GetConfigValue("root_url");?>images/z.gif"
			...
			value="<?php echo $this->GetResourceValue("EditPreviewButton"); ?>" />
		<img src="<?php echo $this->GetConfigValue("root_url");?>images/z.gif"
			class="buttonsspacer" alt="" border="0" /> <input
			...
			onclick="document.location='<?php echo addslashes($this->href("", "", "", 1))?>';" /><br />
			<?php
...
?> <script language="JavaScript" type="text/javascript">
  ...
  </script> <input name="save" class="OkBtn"
	onmouseover='this.className="OkBtn_";'
	onmouseout='this.className="OkBtn";' type="submit" align="top"
	value="<?php echo $this->GetResourceValue("EditStoreButton"); ?>" /> <img
