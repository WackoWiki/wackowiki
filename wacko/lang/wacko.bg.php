...
// other
  ...
  "ExternalPagesGlobal" => "<strong>Външни страници, препращащи на&nbsp;".$wakkaConfig["wakka_name"]."</strong><br /><small> (<a href=\"%1\">списък на сайтовете</a>):</small>",
  ...
  "DomainsSitesPagesGlobal" => "<strong>Сайтове, на които има препратки&nbsp;".$wakkaConfig["wakka_name"]."</strong><br /><small> (<a href=\"%1\">списък на отделните страници</a>):</small>",
  ...
  "ViewReferringSitesGlobal" => "<a href=\"%1\">Сайтове, препращащи на ".$wakkaConfig["wakka_name"]."</a>",
  "ViewReferrersForGlobal" => "<a href=\"%1\">Препратки на ".$wakkaConfig["wakka_name"]."</a>",
