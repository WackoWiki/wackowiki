...
$wacko_translation = [
	...
	'AccountDeleteInfo'			=> 'Von den von dir erstellten Daten (z.B. E-Mail, Einstellungen, Anhänge, Wiki-Einträge) werden so weit wie möglich gelöscht. Beachte jedoch, dass Daten wie Arbeitspakete und Wiki-Einträge nicht gelöscht werden können, ohne die Arbeit der anderen Benutzer zu beeinträchtigen. Diese Daten werden daher einem Konto namens <code>Gelöschter Benutzer</code> zugewiesen. Da die Daten eines jeden gelöschten Kontos diesem Konto wieder zugeordnet werden, ist es nicht möglich, die von dir erstellten Daten von den Daten eines anderen gelöschten Kontos zu unterscheiden.',
