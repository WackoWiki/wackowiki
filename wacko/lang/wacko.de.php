...
$wackoTranslation = array(
	...
	"EmailForgotMessage" => "Jemand (vielleicht du) hat sein Passwort für %1 vergessen.<br />Dein Benutzername lautet: %2<br />Um dein Passwort zu ändern, folge diesem Link oder kopiere ihn in die Adresszeile deines Browsers.<br /><a href=\"%3\">%3</a>",
	...
	"SettingsSize" => "Größe der Seite (Bytes): source / compiled",
	"SettingsCreated" => "Erstellt",
	"SettingsCurrent" => "Aktuelle Version",
	"SettingsTotalRevs" => "Anzahl Revsionen",
	"SettingsTotalComs" => "Anzahl Kommentare",
	"SettingsHits" => "Anzahl Aufrufe",
