...
$wackoTranslation = array(
	...
	"KeywordsFor"			=> "Schlüsselwörter für",
	"KeywordsTip"			=> "Klicke hier um die Schlüsselwörter zu bearbeiten",
	"KeywordsUpdated"		=> "Schlüsselwörter aktualisiert",
	"KeywordsAlreadyExists"	=> "Das Schlüsselwort gibt es bereits.",
	"KeywordsAdded"			=> "Schlüsselwort erfolgreich hinzugefügt.",
	"KeywordsRenamed"		=> "Schlüsselwort erfolgreich umbenannt.",
	"KeywordsUngrouped"		=> "Schlüsselwort erfolgreich degruppiert.",
	"KeywordsGrouped"		=> "Das Schlüsselwort wurde der neuen Guppe hizugefügt.",
	"NoMultilevelGrouping"	=> "Mehrstufiges gruppieren von Schlüsselwörtern ist nicht möglich.",
	"KeywordsDeleted"		=> "Das Schlüsselwort wurde aus der Datenbank und allen Seiten gelöscht.",
	"KeywordsAdd"			=> "Neues Schlüsselwort hinzufügen",
	"KeywordsAddGrouped"	=> "Schlüsselwort gruppieren mit",
	"KeywordsAddGroupedNo"	=> "Nicht gruppieren.",
	"KeywordsRename"		=> "Schlüsselwort umbenennen",
	"KeywordsRenameInfo"	=> "* Hinweis: Änderung betrifft alle Seiten, die diesem Schlüsselwort zugeordnet sind.",
	"KeywordsGroup"			=> "Gruppiere Schlüsselwörter ",
	"KeywordsGroupInfo"		=> "* Wähle <em>[no group]</em>, um das Schlüsselwort zu degruppieren.",
	"KeywordsDelete"		=> "Willst du das Schlüsselwort wirklich entfernen",
	"KeywordsDeleteInfo"	=> "* Hinweis: Die Änderung betrifft alle Seiten, die diesem Schlüsselwort zugeordnet sind. Wenn das Wort eine Unterkategorie hat, wird diese nicht gelöscht, sondern nur entbündelt.",
	"KeywordsStoreInfo" 	=> "Um Schlüsselwörter zu einer Seite zuordnen wähle das jeweilige Kontrollkästchen.",
	"KeywordsStoreButton" 	=> "Speichere Schlüsselwörter",
	"KeywordsSaveButton" 	=> "Speichern",
	"KeywordsCancelButton" 	=> "Abbrechen",
	"KeywordsAddButton"		=> "Hinzufügen",
	"KeywordsRenameButton"	=> "Umbenennen",
	"KeywordsGroupButton"	=> "Gruppiere",
	"KeywordsRemoveButton"	=> "Entfernen",
	"KeywordsEditInfo"		=> "Um die Schlüsselwort-Liste zu bearbeiten wähle das Optionsfeld.",
	"NoKeywordsForThisLanguage"	=> "Schlüsselwörter für diese Sprache wurden nicht definiert.",
	...
	"KeywordsRemoved" => "<em>Keywords gelöscht.</em>",
	...
	"MetaToc"				=> "Zeige Inhaltsverzeichnis",
	"MetaIndex"				=> "Zeige Cluster Leiste",
	"MetaIndexMode"			=> "Zeige Abschnittsart",
	"MetaIndexFull"			=> "Baum",
	...
	"SettingsSize" => "Größe (Quelltext / zusammengestellt)",
	...
	"SettingsKeywords" => "Schlüsselwörter",
	...
	// Flash
	"FlashNoURL" => "Bitte gib einen Flashdatei mit dem Parameter url an. (z.B. {{flash url=\"file:the_movie.swf\"}}",
