...
$wackoTranslation = array(
	...
	// keywords handler
	"Keywords"				=> "Keywords",
	"KeywordsFor"			=> "Keywords für",
	"KeywordsTip"			=> "Klicke hier um die Keywords zu bearbeiten",
	"KeywordsUpdated"		=> "Keywords aktualisiert",
	"KeywordsAlreadyExists"	=> "Das Keyword gibt es bereits.",
	"KeywordsAdded"			=> "Keyword erfolgreich hinzugefügt.",
	"KeywordsRenamed"		=> "Keyword erfolgreich umbenannt.",
	"KeywordsUngrouped"		=> "Keyword erfolgreich degruppiert.",
	"KeywordsGrouped"		=> "Das Keyword wurde der neuen Guppe hizugefügt.",
	"NoMultilevelGrouping"	=> "Mehrstufiges gruppieren von Keywords ist nicht möglich.",
	"KeywordsDeleted"		=> "Das Keyword wurde aus der Datenbank und allen Seiten gelöscht.",
	"KeywordsAdd"			=> "Neues Keyword hinzufügen",
	"KeywordsAddGrouped"	=> "Keyword gruppieren mit",
	"KeywordsAddGroupedNo"	=> "Nicht gruppieren.",
	"KeywordsRename"		=> "Keyword umbenennen",
	"KeywordsRenameInfo"	=> "* Hinweis: Änderung betrifft alle Seiten, die diesem Schlüsselwort zugeordnet sind.",
	"KeywordsGroup"			=> "Gruppiere Keywords ",
	"KeywordsGroupInfo"		=> "* Wähle <em>[no group]</em>, um das Keyword zu degruppieren.",
	"KeywordsDelete"		=> "Willst du das Keywört wirklich entfernen",
	...
	"KeywordsStoreInfo" 	=> "Um Keywords zu einer Seite zuordnen wähle das jeweilige Kontrollkästchen.",
	"KeywordsStoreButton" 	=> "Speichere Keywords",
	...
	"KeywordsEditInfo"		=> "Um die Keyword Liste zu bearbeiten wähle das Optionsfeld.",
	"NoKeywordsForThisLanguage"	=> "Keywords für diese Sprache wurden nicht definiert.",
