...
$wackoTranslation = array(
	...
	"EmailVerify" => "Κάποιος (πιθανόν εσείς) έχει ενεργοποιήσει την ειδοποίηση της ηλεκτρονικής αλληλογραφίας στο %1.<br />Το όνομα χρήστη: %2<br />Αν θέλετε να αποδέχεστε ειδοποιήσεις, πρέπει να αποδεχθείτε το email. Παρακαλώ ακολουθήστε <a href=%3>τον σύνδεσμο</a> για να το κάνετε αυτό.",
