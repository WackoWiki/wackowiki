...
$wackoTranslation = array(
	...
	"ModerateSplitNewName"	=> "Specify a name for separable topic and select a schema separation",
	"ModerateSplitPageName"	=> "Enter the name of the page / topic, where to move detachable comments, and select a schema separation",
