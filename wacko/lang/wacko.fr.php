...
$wackoTranslation = array(
	...
	"Links" => "Liens",
	"Version" => "Version",
	"StandardTerms" => "Termes normalisés",
	...
	// keywords handler
	"Keywords"				=> "Mots clefs",
	"KeywordsFor"			=> "Mots clefs pour",
	"KeywordsTip"			=> "Cliquer pour éditer les mots clefs",
	"KeywordsUpdated"		=> "Mots clefs mis à jour",
	"KeywordsAlreadyExists"	=> "Ce mot clef est déjà là.",
	"KeywordsAdded"			=> "Ajout du mot clef réussi.",
	"KeywordsRenamed"		=> "Changement de nom du mot clef réussi.",
	"KeywordsUngrouped"		=> "Dégroupage du mot clef réussi.",
	"KeywordsGrouped"		=> "Le mot clef a été inclus dans le nouveau groupe.",
	"NoMultilevelGrouping"	=> "Le regroupement de mots clefs sur plusieurs niveaux n'est pas possible.",
	"KeywordsDeleted"		=> "Le mot clef a été effacé de la base de données et de toutes les pages.",
	"KeywordsAdd"			=> "Ajouter un nouveau mot clef",
	"KeywordsAddGrouped"	=> "Groupé avec le mot clef",
	"KeywordsAddGroupedNo"	=> "Pas de groupe.",
	"KeywordsRename"		=> "Renommer le mot clef",
	"KeywordsRenameInfo"	=> "* Note: la modification affectera toutes les pages auxquelles ce mot clef est attaché.",
	"KeywordsGroup"			=> "Groupe de mots clefs ",
	"KeywordsGroupInfo"		=> "* Choisissez <em>[no group]</em>, pour dégrouper le mot clef.",
	"KeywordsDelete"		=> "Êtes-vous sûr de vouloir supprimer le mot clef ? ",
	"KeywordsDeleteInfo"	=> "* Note: la mofification affectera toutes les pages auxquelles ce mot clef est attaché. Si le mot a une sous-catégorie, ses membres  ne seront pas effacés mais seulement dégroupés.",
	"KeywordsStoreInfo" 	=> "Pour attacher des mots clefs à une page cochez-les.",
	"KeywordsStoreButton" 	=> "Sauvegarder les mots clefs",
	"KeywordsSaveButton" 	=> "Sauvegarder",
	"KeywordsCancelButton" 	=> "Annuler",
	"KeywordsAddButton"		=> "Ajouter",
	"KeywordsRenameButton"	=> "Renommer",
	"KeywordsGroupButton"	=> "Grouper",
	"KeywordsRemoveButton"	=> "Enlever",
	"KeywordsEditInfo"		=> "Pour éditer la liste de mots clefs choisissez le bouton radio.",
	"NoKeywordsForThisLanguage"	=> "Les mots clefs pour cette langue ne sont pas définis.",
	...
	"KeywordsRemoved" => "<em>Pages mots-clés effacées.</em>",
	...
	"SettingsSize" => "Taille (source / compilé)",
