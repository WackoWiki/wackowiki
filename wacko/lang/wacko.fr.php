...
$wacko_translation = [
	...
	'AdminText'					=> 'Admin',
	'AdminTip'					=> 'Panneau de contrôle d&rsquo;administration',
	...
	'NameTooShort'				=> 'Le nom d&rsquo;utilisateur est trop court, un minimum de %2 caractères est obligatoire.',
	'NameTooLong'				=> 'Le nom d&rsquo;utilisateur est trop long, un maximum de %2 caractères est autorisé.',
	'NameAlphanumOnly'			=> 'Le nom d&rsquo;utilisateur doit être compris entre %1 et %2 caractères de long et ne doit contenir que des caractères alphanumériques.',
	'NameCamelCaseOnly'			=> 'Le nom d&rsquo;utilisateur doit être compris entre %1 et %2 caractères de long et WikiName formatted.',
	...
	'UserWaitingApproval'		=> 'Un courriel a été envoyé à l&rsquo;administrateur du site, qui examinera les informations soumises et approuvera ou rejettera votre demande.',
	'UserRequiresApproval'		=> 'Pour approuver ou rejeter l&rsquo;accès de l&rsquo;utilisateur à %1 ouvrez le tableau de bord de l&rsquo;administrateur.',
	'UserApprovalInfo'			=> 'Après votre inscription, votre demande sera transmise à l&rsquo;administrateur du site pour approbation. Vous recevrez ensuite un courriel avec des instructions supplémentaires.',
	'UserApprovalHint'			=> 'Vous serz informé de l&rsquo;activation de votre compte par courriel. Il n&rsquo;est pas possible de vous connecter avant.',

	'UserApprovalPending'		=> 'Votre inscription est toujours en attente d&rsquo;approbation.',
	...
	'PendingApproval'			=> 'En attente d&rsquo;approbation',
	...
	'LoginIncorrect'			=> 'Le nom d&rsquou;utilisateur ou le mot de passe est erroné.',
	...
	'SessionReplay'				=> 'Session terminée en raison d&rsquou; une relecture.',
	...
	'SessionUaChange'			=> 'Session terminée suite à changement d&rsquo;utilisateur.',
	'SessionTLSChange'			=> 'Session terminée pour modification de TLS.',
	'SessionIPChange'			=> 'Session terminée pour modification d&rsquo;adresse IP.',
	...
	'NewPageCreatedBody'		=> 'L&rsquo;utilisateur %1 a créé une nouvelle page: ',
	'FileUploadedSubj'			=> 'Un nouveau fichier',
	'FileUploadedBody'			=> 'L&rsquo;utilisateur %1 a déposée un nouveau fichier: ',
	'FileReplacedBody'			=> 'L&rsquo;utilisateur %1 a remplacé le fichier: ',
	...
	'ReadAccessDenied'			=> 'Vous n&rsquo;êtes pas autorisé(e) à  voir cette page.',
	...
	// source handler
	'SourceText'				=> 'Source',
	'SourceTip'					=> 'Voir le code source du wiki (pas de %%-formateurs affichés)',
	...
	'SourceForInfo'				=> 'Vous pouvez voir et copier le contenu de cette page.',
	...
	'WriteAccessDenied'			=> 'Vous n&rsquo;êtes pas autorisé(e) à écrire sur cette page.',
	'EmptyPage'					=> 'La page était vide - elle n&rsquo;a pas été enregistré !',
	'EmptyComment'				=> 'Le commentaire était vide - il n&rsquo;a pas été enregistré !',
	'CommentAccessDenied'		=> 'Vous n&rsquo;êtes pas autorisé à commenter cette page.',
	...
	'NotOwnerCantDelete'		=> 'Vous n&rsquo;êtes pas le propriétaire de cette page et ne pouvez la supprimer',
	...
	'NoDeletedPages'			=> 'Aucune page effacée n&rsquo;a été trouvée.',
	'NoDeletedFiles'			=> 'Aucun fichier supprimé n&rsquo;a été trouvé.',
	...
	// user settings
	'SettingsCodeResent'		=> 'code de confirmation du courriel répété envoyé à votre adresse.',
	'SettingsCodeNotSent'		=> 'Envoi du code de confirmation impossible: adresse courriel non spécifiée!',
	'Hello'						=> 'Bonjour',
	...
	'EmailTaken'				=> 'L&rsquo;adresse e-mail que vous avez saisie est déjà utilisée.',
	...
	'AlreadyNamed'				=> 'Cette page s&rsquo;appelle déjà <strong>%1</strong>.',
	'PageRenamed'				=> 'Page renommée.',
	'NewNameOfPage'				=> 'Nouveau nom de cette page: ',
	'NotOwnerCantRename'		=> 'Vous ne pouvez pas renommer cette page dont vous n&rsquo;êtes pas le propriétaire',
	...
	'NotifyDigest'				=> 'Digest',
	'NotifyPendingPageTip'		=> 'Une notification est envoyée seulement pour le première modification d&rsquo;une page que vous surveillez.',
	'NotifyPendingCommentTip'	=> 'Une notification est envoyée seulement pour le premier commentaire d&rsquo;une page que vous surveillez.',
	...
	'PageAlreadyExists'			=> 'Selon l&rsquo;adresse fournie la page %1 existe déjà.',
	...
	'EmailReverify'				=> 'Quelqu&rsquo;un (peut-être vous) a donné votre adresse de messagerie pour recevoir des notifications des modifications ou commentaires sur %1.' . "\n" . 'Votre nom d&rsquo;utilisateur (NomWiki)&nbsp;: %2'."\n\n" . 'Si vous voulez recevoir des notifications, vous devez confirmer votre adresse de messagerie. Pour cela suivez ' . "\n" . '%3' . "\n" . 'ce lien.'."\n\n" . '',
	...
	'NotOwnerToViewWatchers'	=> 'N&rsquo;étant pas le propriétaire de cette page, vous ne pouvez pas voir la liste des utilisateurs qui la surveillent.',
	...
	'UploadQuotaTip'			=> 'Quota d&rsquo;espace pour les dépôts',
	...
	'UsersGroupMembership'		=> 'Groupes dont l&rsquo;utilisateur est membre',
	...
	'UsersPMOversized'			=> 'La taille de votre message excède le maximum autorisé de %1 caractères. '. 'Merci de raccourcir votre le message et de le soumettre à nouveau.',
	...
	'NeedToChangeLang'			=> 'Le code langue "<code>%1</code>" n&rsquo;est pas supporté, il doit être changé.',
	...
	'UploadDirNotWritable'		=> 'Le répertoire de dépôt n&rsquo;est pas accessible en écriture!',
	...
	'FileEditDenied'			=> 'Vous n&rsquo;êtes pas autorisé(e) à modifier ce fichier',
	'FileLabel'					=> 'Étiqueter',
	'FileLabelTip'				=> 'Étiqueter ce fichier',
	'FileRemove'				=> 'Enlever',
	'FileRemovedFromDB'			=> 'Fichier enlevé de la base de données',
	'FileRemovedFromFS'			=> 'Fichier effacé de l&rsquo;ordinateur hôte',
	'FileRemovedFromFSError'	=> 'Il semble impossible d&rsquo;effacer le fichier !',
	'FileRemoveConfirm'			=> '&Ecirc;tes-vous certain(e) de vouloir enlever ce fichier ?',
	'FileRemoveDenied'			=> 'Vous n&rsquo;êtes pas autorisé à enlever ce fichier',
	...
	'NoFileUsage'				=> 'Aucune page n&rsquo;utilise ce fichier.',
	...
	'ForumOutsideCluster'		=> 'Assurez-vous que le code action <code>%1</code> soit situé à l&rsquo; intérieur du groupe de	 forum.',
	...
	'TzZoneArray'	=> [
		...
		'-1'	=> '[UTC - 1] Açores, Cap-Vert, Groenland de l&rsquo;Est',
		'0'		=> '[UTC] Europe de l&rsquo;Ouest, Méridien de Greenwich',
		'1'		=> '[UTC + 1] Europe Centrale, Afrique de l&rsquo;Ouest',
		'2'		=> '[UTC + 2] Europe de l&rsquo;Est, Afrique Centrale',
		'3'		=> '[UTC + 3] Moscou, Afrique de l&rsquo;Est',
		'3.5'	=> '[UTC + 3:30] Iran',
		'4'		=> '[UTC + 4] Gulf, Samara',
		...
		'8'		=> '[UTC + 8] Chine, Australie de l&rsquo;Ouest, Irkutsk',
		'8.75'	=> '[UTC + 8:45] Australie du Sud-Est',
		'9'		=> '[UTC + 9] Japon, Corée, Chita',
		'9.5'	=> '[UTC + 9:30] Australie Centrale',
		'10'	=> '[UTC + 10] Australie de l&rsquo;Est, Vladivostok',
	...
	'LogAdminLoginLocked'		=> 'connexion verrouillée dans le panneau d&rsquo;administration',
	...
	'LogRemovedPoll'			=> '!!Sondage avec l&rsquo;ID %1 enlevé!!',
	...
	'LogPollCreated'			=> 'Nouveau sondage avec l&rsquo;ID %1',
	'LogPollChanged'			=> 'Contenu du sondage avec l&rsquo;ID %1 modifié',
	'LogPollStarted'			=> 'Sondage démarré avec l&rsquo;ID %1',
	'LogPollReset'				=> 'Réinitialisation des résultats du sondage avec l&rsquo;ID %1',
	'LogPollStopped'			=> 'Arrêt du sondage avec l&rsquo;ID %1',
	...
	'LogErrorSplitComments'		=> 'Erreur lors de la séparation des commentaires du sujet [[/%]] d&rsquo;un nouveau sujet ##%2##: la page n&rsquo;a pas été créée',
	...
	'ErrorMinPHPVersion'		=> 'La version PHP doit être supérieure à  <strong>' . PHP_MIN_VERSION .
									'</strong>, votre serveur apparaît utiliser une version <strong>' . PHP_VERSION . '</strong>.' .
