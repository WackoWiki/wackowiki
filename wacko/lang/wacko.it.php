...
$wackoTranslation = array(
	...
	"RegistrationNameOwned" => "Il nome � gi� utilizzato, scegline un altro.",
	...
	"ShowTip" => "Clicca per tornare in modalit� visione",
	"ShowText" => "Visiona",
	...
	"Comments_1" => "C'� un commento per questa pagina.",
	...
	"Revision" => "Questa � una vecchia versione di <a href=\"%1\">%2</a> da %3.",
	"ReadAccessDenied" => "<em>Non ti � consentito vedere questa pagina.</em>",
	"YouAreOwner" => "Questa pagina � di tua propriet�.",
	"Owner" => "Propriet�: ",
	"Nobody" => "Nessuno",
	...
	"ACLGaveOwnership" => " e propriet� assegnata a ",
	...
	"OverwriteAlert" => "AVVISO DI SOVRASCRITTURA: Questa pagina � stata modificata da qualcun altro mentre la trattavate.<br />Copia le tue modifiche e ri-edita questa pagina.",
	"WriteAccessDenied" => "<em> Non puoi scrivere su questa pagina.</em>",
	"EmptyComment" => "Il corpo del commento � vuoto -- non salvarlo!",
	"CommentAccessDenied" => "<em>Spiacente, non ti � permesso impostare commenti per questa pagina.</em>",
	"YouAreNowTheOwner" => "Si � ora il proprietario di questa pagina.",
	...
	"ThisActionHavenotUndo" => "Questa azione non pu� essere annullata.",
	...
	"NoAccessToSourcePage" => "<em>Non ti � permesso leggere la pagina-sorgente dell'azione.</em>",
	"SourcePageDoesntExist" => "La pagina-sorgente dell'azione non esiste ancora",
	"NotLoggedInThusEdited" => "<em> Non sei connesso, dunque la lista delle pagine da te editate non pu� essere richiamata.</em>",
	"DidntEditAnyPage" => "<em>Non hai ancora editato alcuna pagina.</em>",
	"NoPagesFound" => "<em>Nessuna pagina � stata trovata.</em>",
	"MyChangesTitle1" => "Questa � la lista delle pagine da te editate, ordinate secondo la data delle ultime modifiche fatte",
	"MyChangesTitle2" => "Questa � la lista delle pagine editate, con il tempo della tua ultima modifica",
	"OrderABC" => "in ordine alfabetico",
	"OrderDate" => "in ordine di data",
	"OrderChange" => "in ordine di modifica",
	"ListOwnedPages" => "Questa � la lista di pagine che possiedi (in ordine alfabetico)",
	"ListOwnedPages2" => "Questa � la lista di pagine che possiedi (in ordine di data)",
	"ListOwnedPages3" => "Questa � la lista di pagine che possiedi (in ordine di modifica)",
	"YouDontOwn" => "<em>Non possiedi alcuna pagina.</em>",
	"NotLoggedInThusOwned" => "<em>Non sei connesso, perci� la lista delle tue pagine non pu� essere richiamata.</em>",
	...
	"PostedBy"  => "postato da",
	"ThisIsCommentOn" => "Questo � un commento su",
	"At" => "at",
	"To" => "to",
	"By" => "by",
	"From" => "from",
	...
	"AlreadyRegistered" => "Se sei un utente gi� registrato, connettiti da qui!",
	...
	"SeeListOfPages" => "Vedi l'elenco delle pagine di tua propriet� (MiePagine) e da te editate (MieModifiche).",
	...
	"AlertReferringPages" => "La pagina � richiamata da queste altre pagine",
	...
	"AlredyExists" => "<em>La pagina <strong>%1</strong> gi� esiste.</em>",
	"AlreadyNamed" => "<em> La pagina ha gi� il nome <strong>%1</strong>.</em>",
	...
	"NotOwnerAndCantRename" => "<em> Questa pagina non � tua, non puoi rimuoverla </em>",
	...
	"PageAlreadyExists" => "Secondo l'indirizzo della pagina gi� esistente.",
	...
	"PageMoved" => "La pagina � stata spostata. Puoi trovarla qui",
	...
	"EmailNotConfirmed" => "L'email non pu� essere confermata. This may be due to an incorrect confirmation code or the email address may already be confirmed. You can check if the email address is already confirmed by logging in and viewing its status on your %1 page.",
	...
	"SettingsTip" => "Altre impostazioni e le propriet� di questa pagina",
	"SettingsPortal" => "Altre impostazioni e le propriet� di questa pagina:",
	...
	"Files_0" => "Non vi � alcun file in questa pagina.",
	"Files_1" => "Vi � un file in questa pagina.",
	...
	"BadName" => "Scelto il nome non � valido",
	...
	"RegistrationClosed" => "La registrazione non � disponibile qui. Prova a contattare l'amministratore del sito.",
	...
	"SpamAlert" => "La parola inserita non � corretta",
