...
$wackoTranslation = array(
	...
	"ExternalPagesGlobal" => "<strong>Pagini externe, ce se adreseaza la&nbsp;".$wackoConfig["wacko_name"]."</strong><br /><small> (<a href=\"%1\">lista site-urilor</a>):</small>",
	"DomainsSitesPages" => "<strong>Site-uri, на которых есть ссылки на&nbsp;%1</strong><br /><small> (%2) (<a href=\"%3\" >lista separata a paginilor</a>):</small>",
	"DomainsSitesPagesGlobal" => "<strong>Site-uri, pe care sunt link-uri la&nbsp;".$wackoConfig["wacko_name"]."</strong><br /><small> (<a href=\"%1\">lista separata a paginilor</a>):</small>",
	...
	"ViewReferringSitesGlobal" => "<a href=\"%1\">Site-uri, ce se adreseaza la ".$wackoConfig["wacko_name"]."</a>",
	"ViewReferrersForGlobal" => "<a href=\"%1\">Link-uri la ".$wackoConfig["wacko_name"]."</a>",
	...
	"EmailRegistered" => "Вы успешно зарегистрировались в %1.<br />Ваш логин: %2<br />Чтобы получать уведомления, Вам необходимо подтвердить ваш электронный адрес. Чтобы сделать это, Apasati <a href=%3>на ссылку</a>.",
	...
	"EmailForgotMessage" => "Кто-то забыл Ваш пароль в %1.<br />Ваш логин: %2<br />Чтобы изменить Ваш пароль, вам необходимо щелкнуть по указанной ссылке или скопировать ее в адресную строку браузера.<br /><a href=\"%3\">%3</a>",
