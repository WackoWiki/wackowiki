...
$wackoTranslation = array(
	...
	"RegistrationName" => "Alegeti NumePrenume ((WackoWiki:Doc/������������/������������������ NumePrenume))",
	...
	"DomainsSitesPages" => "<strong>Site-uri, �� ������� ���� ������ ��&nbsp;%1</strong><br /> (%2) (<a href=\"%3\" >lista separata a paginilor</a>):",
	...
	"LinksRemoved" => "<em>Link-urile locale � %1 sunt lichidate.</em>",
	...
	"Email" => "E-mail",
	"MustBeWikiName" => "Numele de utilizator trebuie sa fie ((WackoWiki:Doc/������������/������� ����������)) ",
	...
	"ShowSpaces" => "Arata spatziile libere in � ����������",
	...
	"EmailNotConfirmed" => "� ���������, ��� email �� ����� ���� ����������. This may be due to an incorrect confirmation code or the email address may already be confirmed. You can check if the email address is already confirmed by logging in and viewing its status on your %1 page.",

	"ForgotComment" => "Introdu loginul sau e-mailul\n si vei primi scrisoarea cu instructiuni.",
	"ForgotMain" => "Ai uitat parola?",
	"ForgotField" => "((WackoWiki:Doc/������������/������������������ ����������)) ��� ����� ����������� �����",
	"SendButton" => "Trimite",
	...
	"CodeWasSent" => "���������� �� �������������� ������ ���������� ��� �� ����������� �����.",
	"WrongCode" => "<em>�������� ���</em>",
	"YouWantChangePasswordForUser" => "����� ������ pentru ������������ %1",
	...
	"MetaInfo" => "�������� �����/�������� &ndash; ����, ����������� � HTML-��������� ������ Paginile (META).",
	"MetaTitle" => "Title",
	"MetaKeywords" => "�������� �����",
