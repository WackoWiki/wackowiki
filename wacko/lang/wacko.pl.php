...
$wacko_translation = array(
	...
	'ACLCreate' => '<strong>Create:</strong>',
	...
	'AclsRemoved' => 'Listy praw dostêpu do strony %1 zosta³y usuniête.',
	'BookmarksRemoved' => 'Bookmarks from page %1 usuniête.',
	'WatchesRemoved' => 'Watches from page %1 usuniête.',
	'CommentsRemoved' => 'Comments from page %1 usuniête.',
	'FilesRemoved' => 'Files from page %1 usuniête.',
	'PageRemoved' => 'Strona %1 zosta³a usuniêta.',
	'ClusterRemoved' => 'All pages of the cluster removed.',
	'RevisionsRemoved' => 'Revisions from page %1 usuniête.',
	...
	'AlredyExists' => 'Przepraszamy! Strona o nazwie <strong>%1</strong> ju¿ istnieje.',
	'AlreadyNamed' => 'Ta strona ju¿ ma nazwê <strong>%1</strong>.',
	'PageRenamed' => 'Nazwa strony %1 zosta³a zmieniona.',
	...
	'pdficon'  => '<img src="{theme}icon/pdf.png" alt="PDF Document" />',
	'rdficon'  => '<img src="{theme}icon/rdf.png" alt="RDF Document" />',
	'emailicon' => '<img src="{theme}icon/mail.png" alt="" />',
	'jabbericon' => '<img src="{theme}icon/jabber.png" alt="xmpp" />',
	'lockicon' => '<img src="{theme}icon/lock.png" alt="Dostêp zabroniony" />',
	'keyicon' => '<img src="{theme}icon/key.png" alt="Strona z niestandardowym dostêpem" />',
	'wantedicon' => '?',
