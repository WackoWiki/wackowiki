...
$wacko_translation = [
	...
	'EmailRegistered'			=> 'Dziękujemy! Twoja rejestracja została zakończona pomyślnie' . "\n" . 'Nazwa użytkownika: %2'."\n\n" . 'Aby włączyć możliwość otrzymywania powiadomień z tej strony należy potwierdzić swój adres e-mail. W tym celu należy połączyć się z ' . "\n" . '%3' . "\n" . 'tą stroną.',
