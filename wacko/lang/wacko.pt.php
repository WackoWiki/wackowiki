...
$wacko_translation = [
	...
	'AccountDeleteInfo'			=> 'Dos dados que o utilizador criou (ex: email, preferências, anexos, entradas wiki), será apagado o máximo possível. No entanto note que esses dados, como anexos e entradas wiki, não podem ser apagados sem impedir o trabalho de outros utilizadores. Esses dados serão então reatribuídos para uma conta chamada <code>Utilizador apagado</code>. Uma vez que todas as contas apagadas são reatribuídas para esta conta, não será possível distinguir os dados que o utilizador criou dos dados de outra conta apagada.',
