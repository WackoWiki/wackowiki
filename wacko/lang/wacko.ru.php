...
$wacko_translation = [
	...
	'UsersIntercomDesc'			=> 'Обратите внимание: отправка личного сообщения производится на email-адрес получателя без раскрытия вашего адреса. Получатель сможет ответить вам, используя аналогичную форму на странице вашего профиля. ',
