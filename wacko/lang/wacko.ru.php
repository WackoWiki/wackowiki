...
$wackoTranslation = array(
	...
	"YouArePanelAccount" => "моя учетная запись",
	"LogoutLink"  => "Выход",
	...
	"AllowIntercom" => "Разрешить приватные сообщения от пользователей системы",
	...
	"EmailRegistered" => "Вы успешно зарегистрировались в %1.\nВаше имя пользователя: %2\n\nЕсли вы хотите получать уведомления, необходимо подтвердить адрес электронной почты. Для этого пройдите, пожалуйста, \n%3\nпо ссылке.\n",
	...
	"EmailNotVerifiedDesc" => "Вы не сможете получать уведомления об изменении и комментариях ".
							...
							"вы так и не получили письмо, запросите его повторно, щелкнув ",
	...
	'UsersGetPubkey'		=> 'Получить открытый ключ',
	'UsersGetKeyNet'		=> 'с сервера ключей',
	'UsersGetKeySite'		=> 'из нашего хранилища',
	...
	'UsersIntercomEncrypt'	=> 'Зашифровать сообщение открытым ключом пользователя',
	'UsersIntercomDesc'		=> 'Обратите внимание: отправка персонального сообщения производится на email-адрес '.
	...
	'UsersIntercomDesc2'	=> 'Если пользователь разместил на сайте свой открытый ключ PGP, вы можете отправить ему письмо в зашифрованном виде (оно будет автоматически зашифровано сервером). ',
	...
	'UsersPMFlooded'		=> 'Интервал между отправкой персональных сообщений должен быть не менее %1 секунд.',
	'UsersPMSent'			=> 'Персональное сообщение успешно отправлено пользователю.',
	'UsersPMEncSent'		=> 'Персональное сообщение было зашифровано и успешно отправлено пользователю.',
	'UsersPMPlnSent'		=> 'Персональное сообщение отправлено пользователю открытым текстом.',
	...
	'UsersPMUnusablePubkey'	=> 'Внимание: открытый ключ пользователя непригоден для зашифрования. Невозможно отправить зашифрованное сообщение.',
	'UsersPMNotLoggedIn'	=> 'Вы не зарегистрированы в системе и не можете отправлять персональные сообщения пользователям.',
	...
	"PollsSubmit"		=> "готово",
	"PollsNeedTopic"	=> "Вы не указали тему или вопрос для голования.",
