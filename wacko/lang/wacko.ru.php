...
$wackoTranslation = array(
	...
	"ValidateIP" => "Привязывать сессию к IP (не используйте через Tor)",
	'ProfileAnonymousPub' => "Предпочтительно публиковаться анонимно (скрывать имя)",
	...
	"EmailForgotMessage" => "Кто-то забыл ваш пароль в %1.\nВаше имя пользователя: %2\n\nЧтобы изменить пароль, необходимо щёлкнуть по указанной ссылке или скопировать ее в адресную строку браузера.\n%3\n\n",
