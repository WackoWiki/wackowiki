...
$wackoTranslation = array(
	...
	// keywords handler
	"Keywords"				=> "Keywords",
	"KeywordsFor"			=> "Ключевые слова документа",
	"KeywordsTip"			=> "Click to edit keywords",
	"KeywordsUpdated"		=> "Ключевые слова документа обновлены.",
	"KeywordsAlreadyExists"	=> "Такое ключевое слово уже существует.",
	"KeywordsAdded"			=> "Ключевое слово успешно добавлено.",
	"KeywordsRenamed"		=> "Ключевое слово успешно переименовано.",
	"KeywordsUngrouped"		=> "Ключевое слово успешно разгруппировано.",
	"KeywordsGrouped"		=> "Ключевое слово внесено в новую группу.",
	"NoMultilevelGrouping"	=> "Многоуровневая группировка ключевых слов невозможна.",
	"KeywordsDeleted"		=> "Ключевое слово удалено из базы данных и из всех документов.",
	"KeywordsAdd"			=> "Добавить новое ключевое слово",
	"KeywordsAddGrouped"	=> "Сгруппировать с ключевым словом",
	"KeywordsAddGroupedNo"	=> "Не группировать.",
	"KeywordsRename"		=> "Переименовать ключевое слово",
	"KeywordsRenameInfo"	=> "* Внимание: изменение затронет все документы, которым присвоено это ключевое слово.",
	"KeywordsGroup"			=> "Сгруппировать ключевое слово ",
	"KeywordsGroupInfo"		=> "* Выберите <em>[no group]</em>, чтобы разгруппировать ключевое слово.",
	"KeywordsDelete"		=> "Вы уверены, что хотите удалить ключевое слово ",
	"KeywordsDeleteInfo"	=> "* Внимание: изменение затронет все документы, которым присвоено это ключевое слово. Если слово имеет подкатегории, они не будут удалены, а только разгруппированы.",
	"KeywordsStoreInfo" 	=> "Присвоить документу ключевые слова, выделенные флажками.",
	"KeywordsStoreButton" 	=> "Сохранить Keywords",
	"KeywordsSaveButton" 	=> "готово",
	"KeywordsCancelButton" 	=> "Отмена",
	"KeywordsAddButton"		=> "добавить",
	"KeywordsRenameButton"	=> "переименовать",
	"KeywordsGroupButton"	=> "группировать",
	"KeywordsRemoveButton"	=> "удалить",
	"KeywordsEditInfo"		=> "Отредактировать список ключевых слов (нужное выделить переключателем).",
	"NoKeywordsForThisLanguage"	=> "Ключевые слова для данного языка не заданы.",
	...
	"SettingsSize" => "Объём документа (байт): исходный / скомпилированный",
	...
	"ForumNoTopicName"	=> "Укажите название для новой страницы.",
