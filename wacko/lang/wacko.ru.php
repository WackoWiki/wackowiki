...
// other
  ...
  "ExternalPagesGlobal"=> "<strong>Внешние страницы, ссылающеся на&nbsp;".$wackoConfig["wacko_name"]."</strong><br /><small> (<a href=\"%1\">список сайтов</a>):</small>",
  "DomainsSitesPages"  => "<strong>Сайты, на которых есть ссылки на&nbsp;%1</strong><br /><small> (%2)  (<a href=\"%3\" >список отдельных страниц</a>):</small>",
  "DomainsSitesPagesGlobal" => "<strong>Сайты, на которых есть ссылки на&nbsp;".$wackoConfig["wacko_name"]."</strong><br /><small> (<a href=\"%1\">список отдельных страниц</a>):</small>",
  ...
  "ViewReferringSitesGlobal" => "<a href=\"%1\">Сайты, ссылающиеся на ".$wackoConfig["wacko_name"]."</a>",
  "ViewReferrersForGlobal" => "<a href=\"%1\">Ссылки на ".$wackoConfig["wacko_name"]."</a>",
