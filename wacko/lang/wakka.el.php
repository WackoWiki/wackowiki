...
// other
  ...
  "Typografica" => "Αυτόματη διόρθωση των τυπογραφιων κατά την προβολή",
  ...
  "ReferrersTip" => "Πατήστε για να δείτε μία λίστα από URLs που παραμπέμουν σε αυτή την σελίδα",
  ...
  "History" => "Ιστορικό",
  "ReEditOldRevision" => "Επα-επεξεργασία της παλαιτότερης έκδοσης",
