...
// other
  ...
  "EmailRegistered" => "Εγγραφήκατε επιτυχώς στο %1.<br />Το όνομα σύνδεσή σας είναι: %2<br />Εάν θέλετε να λαμβάνετε ειδοποιήσεις, χρειάζεται να πιστοποιήσετε το ηλεκτρονικό σας  ταχυδρομείο. Παρακαλώ μεταβείτε <a href=%3>σε αυτό το σύνδεσμο</a> για να το κάνετε.",
...
στο %1.<br />Το όνομα χρήστη: %2<br />Αν θέλετε να αποδέχεστε ειδοποιήσεις, πρέπει να αποδεχθείτε το email. Παρακαλώ ακολουθήστε <a href=%3>τον σύνδεσμο</a> για να το κάνετε αυτό.",
  ...
  "EmailForgotMessage" => "Κάποιος (ακόμα και εσείς) ξέχασε το συνθηματικό για το %1.<br />Όνομα σύνδεσης: %2<br />Πατήστε επάνω στο παρακάτω url link ή αντιγράψτε στο στην γραμμή διευθύνσεων του περιηγητή διαδικτύου σας για να αλλάξετε το συνθηματικό σας.<br /><a href=\"%3\">%3</a>",
