...
// other
  ...
  "ExternalPagesGlobal" => "<strong>Pagini externe, ce se adreseaza la&nbsp;".$wakkaConfig["wakka_name"]."</strong><br /><small> (<a href=\"%1\">lista site-urilor</a>):</small>",
  ...
  "DomainsSitesPagesGlobal" => "<strong>Site-uri, pe care sunt link-uri la&nbsp;".$wakkaConfig["wakka_name"]."</strong><br /><small> (<a href=\"%1\">lista separata a paginilor</a>):</small>",
  ...
  "ViewReferringSitesGlobal" => "<a href=\"%1\">Site-uri, ce se adreseaza la ".$wakkaConfig["wakka_name"]."</a>",
