...
// other
  ...
  "Comparison" => "<b>Сравнение версий %3 от %1 и %2</b>",
  ...
  "ReallyDelete" => "Вы действительно хотите УДАЛИТЬ страницу? <br />Восстановить её потом не удастся.<br /><br />ВНИМАНИЕ: при удалении страницы будут удалены все её версии, комментарии, ссылки и т. п.",
  ...
  "SearchTitleHelp" => "Нажмите, чтобы вывести все страницы, имеющие данный заголовок.",
  ...
  "Mail.Registered" => "Вы успешно зарегистрировались в %1.<br />Ваше имя пользователя: %2<br />Если вы хотите получать уведомления, необходимо подтвердить адрес электронной почты. Для этого пройдите, пожалуйста, <a href=%3>по ссылке</a>.",
  "Mail.Verify" => "Кто-то (возможно, вы), указал ваш электронный адрес в %1.<br />Ваше имя пользователя: %2<br />Если вы хотите получать уведомления, необходимо подтвердить адрес электронной почты. Для этого пройдите, пожалуйста, <a href=%3>по ссылке</a>.",
  "Mail.Confirm" => "Запрос на подтверждение адреса электронной почты",
  ...
  "Mail.ForgotMessage" => "Кто-то забыл ваш пароль в %1.<br />Ваше имя пользователя: %2<br />Чтобы изменить пароль, необходимо щёлкнуть по указанной ссылке или скопировать ее в адресную строку браузера.<br /><a href=\"%3\">%3</a>",
