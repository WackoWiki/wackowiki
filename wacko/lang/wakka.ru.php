...
// registration panel
  ...
  "RegistrationName" => "Придумайте себе ((WackoWiki:Doc/Документация/ЧтоТакоеИмяФамилия ИмяФамилию))",
...
// login panel
  ...
  "LoginName" => "((WackoWiki:Doc/Документация/ЧтоТакоеИмяФамилия ИмяФамилия @@ru))",
...
// other
  ...
  "MustBeWikiName" => "Имя пользователя должно быть ((WackoWiki:Doc/Документация/ВикиИмя ВикиИменем)) ",
