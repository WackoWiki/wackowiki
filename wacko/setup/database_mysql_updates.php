...
$alter_page_r4_3_22 = "ALTER TABLE {$pref}page ADD footer_comments TINYINT(1) UNSIGNED DEFAULT '1'";
$alter_page_r4_3_23 = "ALTER TABLE {$pref}page ADD footer_files TINYINT(1) UNSIGNED DEFAULT '1'";
$alter_page_r4_3_24 = "ALTER TABLE {$pref}page ADD footer_rating TINYINT(1) UNSIGNED DEFAULT '1'";
