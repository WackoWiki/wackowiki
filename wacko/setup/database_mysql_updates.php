...
$alter_user_r4_3_17 = "ALTER TABLE {$pref}user CHANGE password password VARCHAR(40) NOT NULL DEFAULT ''";
$alter_user_r4_3_18 = "ALTER TABLE {$pref}user CHANGE signuptime signup_time DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'";
$alter_user_r4_3_19 = "ALTER TABLE {$pref}user CHANGE changepassword change_password VARCHAR(40) NOT NULL";
