...
$alter_pages_r4_2_21 = "ALTER TABLE {$pref}pages ADD commented DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' AFTER title, ADD INDEX idx_commented (commented)";
$alter_pages_r4_2_22 = "ALTER TABLE {$pref}pages ADD hide_comments TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_23 = "ALTER TABLE {$pref}pages ADD hide_files TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_24 = "ALTER TABLE {$pref}pages ADD hide_rating TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_25 = "ALTER TABLE {$pref}pages ADD hide_toc TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_26 = "ALTER TABLE {$pref}pages ADD hide_index TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_27 = "ALTER TABLE {$pref}pages ADD lower_index TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_28 = "ALTER TABLE {$pref}pages ADD upper_index TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_29 = "ALTER TABLE {$pref}pages ADD allow_rawhtml TINYINT(1) UNSIGNED DEFAULT NULL";
$alter_pages_r4_2_30 = "ALTER TABLE {$pref}pages ADD disable_safehtml TINYINT(1) UNSIGNED DEFAULT NULL";
