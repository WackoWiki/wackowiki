...
$update_config_r5_4_1 = "DELETE FROM {$pref}config WHERE config_name IN ('session_expiration', 'x_csp', 'x_frame_option', 'session_encrypt_cookie', 'allow_swfobject', 'revisions_hide_cancel', 'date_precise_format', 'date_macro_format', 'phpmailer', 'npjlinks', 'meta_description', 'meta_keywords', 'session_match_ip', 'session_match_useragent')";
