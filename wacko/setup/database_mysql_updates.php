...
$alter_pages_r4_3 = "ALTER TABLE ".$config2["table_prefix"]."pages MODIFY COLUMN tag VARCHAR(250) NOT NULL";
$alter_pages_r4_3_2 = "ALTER TABLE ".$config2["table_prefix"]."pages MODIFY COLUMN body MEDIUMTEXT NOT NULL";
$alter_pages_r4_3_3 = "ALTER TABLE ".$config2["table_prefix"]."pages MODIFY COLUMN body_r MEDIUMTEXT NOT NULL";
...
$alter_revisions_r4_3_1 = "ALTER TABLE ".$config2["table_prefix"]."revisions MODIFY COLUMN body MEDIUMTEXT NOT NULL";
$alter_revisions_r4_3_2 = "ALTER TABLE ".$config2["table_prefix"]."revisions MODIFY COLUMN body_r MEDIUMTEXT NOT NULL";
