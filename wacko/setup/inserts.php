...
function insert_page($tag, $title = false, $body, $lng, $rights = 'Admins', $critical = false, $is_menu = false, $menu_title = false)
{
	...
	$page_insert			= "INSERT INTO ".$config_global['table_prefix']."page (tag, supertag, title, body, body_r, body_toc, user_id, owner_id, created, modified, latest, lang, footer_comments, footer_files, footer_rating) VALUES ('".$tag."', '".translit($tag, $lng)."', '".$title."' , '".$body."', '', '', (".$owner_id."), (".$owner_id."), NOW(), NOW(), '1', '".$lng."', '0', '0', '0')";
