...
insert_page('UltimeModifiche', 'Ultime Modifiche', '{{changes}}', $lng, 'Admins', false, true);
insert_page('UltimiCommenti', 'Ultimi Commenti', '{{RecentlyCommented}}', $lng, 'Admins', false, true);
insert_page('IndicePagine', 'Indice Pagine', '{{PageIndex}}', $lng, 'Admins', false, true);
