...
insert_page('PaginaIndex', 'Pagina Index', '{{PageIndex}}', $lng, 'Admins', false, true);
insert_page('LaatsteWijzigingen', 'Laatste Wijzigingen', '{{changes}}', $lng, 'Admins', false, true);
insert_page('LaatsteOpmerkingen', 'Laatste Opmerkingen', '{{RecentlyCommented}}', $lng, 'Admins', false, true);
