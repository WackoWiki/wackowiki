...
insert_page('AlteraçõesRecentes', 'Alterações Recentes', '{{changes}}', $lang, 'Admins', false, true, 'Alterações');
insert_page('RecentementeComentadas', 'Recentemente Comentadas', '{{commented}}', $lang, 'Admins', false, true, 'Comentadas');
insert_page('ÍndicedePáginas', 'Índicede Páginas', '{{pageindex}}', $lang, 'Admins', false, true, 'Índicede');
