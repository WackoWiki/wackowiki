...
'Base' => 'Базов URL',
'BaseDesc' => 'Базов URL  на вашата инсталация на  WackoWiki. Имената на страниците се присъединяват към него с forward slash, ако не може да се ползва mod_rewrite i.e.</p><ul><li><b><i>http://example.com/</i></b></li><li><b><i>http://example.com/wiki/</i></b></li></ul>',
