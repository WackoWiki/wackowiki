...
"NameDesc" => "Име на вашия WackoWiki. Трябва да е от типа УикиИме и изглежда ПримерноЕтоТака. <a href=\"http://wackowiki.org/Archiv/DocEnglish/WikiName\" title=\"View Help\" target=\"_blank\">WikiName</a>.",
...
"Admin" => "Име",
"AdminDesc" => "Изберете име. Нещо от тип <a href=\"http://wackowiki.org/Archiv/DocEnglish/WikiName\" title=\"View Help\" target=\"_blank\">WikiName</a> (без кирилица).",
"Password" => "Име Парола",
...
"ErrorGivePrivileges" => "Конфигурационния файл %1 не може да се запише. Трябва сега временно да се променят правата за достъп до (мястото на) този файл или да се направи празен файл <tt>wakka.config.php</tt> (<tt>touch wakka.config.php ; chmod 666 wakka.config.php</tt>; не забравяйте накрая да забраните обратно правата, т.e. <tt>chmod 644 wakka.config.php</tt>). Ако нещо не става, ще трябва да копирате и запишете следващия текст в нов празен файл на вашия компютър и после да го прехвърлите с име <tt>wakka.config.php</tt> на сървъра в главната директория на Wacko. При проблеми, вижте (англ.) <a href=\"http://wackowiki.org/DocEnglish/Installation\" target=\"_blank\">WackoWiki:DocEnglish/Installation</a> или (руски) <a href=\"http://wackowiki.de/Archiv/DocEnglish/Installation\">WackoWiki:Документация/Установка</a>",
