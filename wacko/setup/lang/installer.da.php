...
'OK' => 'OK',
'Problem' => 'Problem',
'NotePermissions' => 'This installer will try to write the configuration data to the file <code>config.php</code>, located in your WackoWiki directory. In order for this to work, you must make sure the web server has write access to that file.  If you can\'t do this, you will have to edit the file manually (the installer will tell you how).<br /><br />See <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a> for details.',
...
'Name' => 'WackoWiki Name',
'NameDesc' => 'Please enter the name of your WackoWiki site, this should be a <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiName</a>.',
'Home' => 'Home Page',
...
'Admin' => 'Admin Name',
'AdminDesc' => 'Enter the admins username, this should be a <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiName</a> (e.g. WikiAdmin).',
