...
'PleaseBackup' => 'Bitte erstelle eine <strong>Sicherungskopie</strong> von deiner Datenbank, der Konfigurationsdatei config.php und aller geänderter Dateien (ggf. auch Layouts) bevor du den Aktualisierungsvorgang beginnst. Das kann dir im Problemfall viel Ärger ersparen.',
...
'Name' => 'WackoWiki Name',
'NameDesc' => 'Der Name deines WackoWikis. Normalerweise ist das ein <a href="https://wackowiki.sourceforge.io/doc/Doc/Deutsch/WikiName" title="Hilfe lesen" target="_blank">WikiName</a> und sieht EtwaSoAus (z.B. MeinWackoWiki).',
'Home' => 'Startseite',
'HomeDesc' => 'Der Name der Startseite deines WackoWikis. Sollte ein WikiName sein (z.B. StartSeite)., dies wird die Startseite sein deines Wikis und sollte ein <a href="https://wackowiki.sourceforge.io/doc/Doc/Deutsch/WikiName" title="Hilfe lesen" target="_blank">WikiName</a> sein.',
...
'AdminDesc' => 'Gib den Benutzernamen des Verwalters an. Sollte ein <a href="https://wackowiki.sourceforge.io/doc/Doc/Deutsch/WikiName" title="Hilfe lesen" target="_blank">WikiName</a> sein (z.B. WikiAdmin).',
...
'Rewrite' => 'Umschreiben',
'RewriteDesc' => '<a href="https://wackowiki.sourceforge.io/doc/Doc/Deutsch/RewriteModus" target="_blank">Umschreiben</a> sollte aktiviert sein, falls du WackoWiki mit URL-Umschreiben verwenden willst.',
'Enabled' => 'Aktiviert:',
...
'ErrorGivePrivileges' => 'Die Konfigurationsdatei <code>config.php</code> konnte nicht geschrieben werden. Du musst dem Webserver vorübergehend Schreibrechte auf das WackoWiki Verzeichnis oder auf eine leere Datei <code>config.php</code> (<code>touch config.php ; chmod 666 config.php</code> geben; vergiss nicht, das Schreibrecht später wieder zu entziehen, z.B. mit <code>chmod 644 config.php</code>). Falls das aus irgendwelchen Gründen nicht möglich ist, kopiere den folgenden Text in eine neue Datei und speichere diese unter <code>config.php</code> in dem WackoWiki Verzeichnis ab. Danach sollte dein WackoWiki funktionieren. Falls nicht, gehe zu <a href="https://wackowiki.sourceforge.io/doc/Doc/Deutsch/Installation" target="_blank">WackoWiki:Doc/Deutsch/Installation</a>',
'NextStep' => 'Im nächsten Schritt wird das Installationsprogramm versuchen, die aktualisierte Konfigurationsdatei, <code>config.php</code>, zu schreiben. Bitte stelle sicher, dass der Webserver Schreibrechte auf die Datei besitzt oder du musst die Datei von Hand ändern.  Für die Einzelheiten besuche bitte <a href="https://wackowiki.sourceforge.io/doc/Doc/Deutsch/Installation" target="_blank">WackoWiki:Doc/Deutsch/Installation</a>.',
'WrittenAt' => 'eingetragen in ',
'DontChange' => 'Ändere wacko_version nicht von Hand!',
'ConfigDescription' => 'https://wackowiki.sourceforge.io/doc/Doc/Deutsch/Konfiguration',
