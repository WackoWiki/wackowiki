...
'PleaseUpgradeToR5' => 'Bei dir läuft eine alte (pre 5.0.0) Version von WackoWiki (<tt class="version">%1</code>). Um auf diese neue Version von WackoWiki zu aktualisieren, musst du zuerst deine Installation auf <tt class="version">5.0.x</code> updaten.',
'UpgradeFromWacko' => 'Wilkommen bei WackoWiki, es scheint das du von WackoWiki <b><tt class="version">%1</code></b> auf <b><tt class="version">%2</code></b> aktualisierst.  Die nächsten Seiten werden dich durch den Installationsvorgang führen.',
'FreshInstall' => 'Wilkommen bei WackoWiki, du installierst gerade WackoWiki <tt class="version">%1</code>.  Die nächsten Seiten werden dich durch den Installationsvorgang führen.',
