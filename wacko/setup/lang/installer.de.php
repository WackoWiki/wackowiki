...
'PleaseUpgradeToR5' => 'Bei dir läuft eine alte (pre 5.0.0) Version von WackoWiki (<tt class="version">%1</tt>). Um auf diese neue Version von WackoWiki zu aktualisieren, musst du zuerst deine Installation auf <tt class="version">5.0.x</tt> updaten.',
...
'ErrorMinPHPVersion' => 'Die PHP Version muss größer als <strong>5.4.0</strong> sein, dein Server scheint mit einer füheren Version zu laufen.  Du must auf eine aktuellere PHP Version upgraden damit WackoWiki korrekt funktioniert.',
...
'Base' => 'Basis-URL',
'BaseDesc' => 'Die Basis-URL deines WackoWikis. Die Seitennamen werden an diese angehängt., so if you are using mod_rewrite the address should end with a forward slash i.e.</p><ul><li><b><em>http://example.com/</em></b></li><li><b><em>http://example.com/wiki/</em></b></li></ul>',
'Rewrite' => 'Umschreiben',
...
'ErrorInsertingDefaultMenuItem' => 'Fehler beim Setzen der Seite <tt>%1</tt> als Default-Menüeintrag',
