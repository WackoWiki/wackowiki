...
'Base' => 'Βασικό URL',
'BaseDesc' => 'Το βασικό URL των WackoWiki sites σας. Τα ονόματα των σελίδων θα εξαρτώνται από αυτό, ώστε όταν θα χρησιμοποιείτε το mod_rewrite η διεύθυνση θα τελειώνει με μία κάθετο π.χ.</p><ul><li><b><em>http://example.com/</em></b></li><li><b><em>http://example.com/wiki/</em></b></li></ul>',
...
'ErrorAdminPasswordShort' => 'Το συνθηματικό του διαχειριστή είναι πολύ μικρό, το ελάχιστο μήκος είναι 9 χαρακτήρες!',
...
'To' => 'στο',
'AlterTable' => 'Αλλαγή του <code>%1</code> Πίνακα',
...
'ErrorInsertingPage' => 'Σφάλμα κατά την εισαγωγή της <code>%1</code> σελίδας',
'ErrorInsertingPageReadPermission' => 'Σφάλμα ρύθμισης δικαιώματος ανάγνωσης για την <code>%1</code> σελίδα',
'ErrorInsertingPageWritePermission' => 'Σφάλμα ρύθμισης δικαιώματος εγγραφής για την <code>%1</code> σελίδα',
'ErrorInsertingPageCommentPermission' => 'Σφάλμα ρύθμισης δικαιώματος σχόλιου για την <code>%1</code> σελίδα',
...
'ErrorPageAlreadyExists' => 'Η <code>%1</code> σελίδα ήδη υπάρχει',
'ErrorAlteringTable' => 'Σφάλμα αλλαγής <code>%1</code> πίνακα',
'ErrorRenamingTable' => 'Error renaming <code>%1</code> table',
'ErrorUpdatingTable' => 'Error updating <code>%1</code> table',
'CreatingTable' => 'Δημιουργία πίνακα: <code>%1</code>',
'ErrorAlreadyExists' => 'Ο <code>%1</code> υπάρχει ήδη',
'ErrorCreatingTable' => 'Σφάλμα κατά την δημιουργία του πίνακα: <code>%1</code>, δεν υπάρχει ήδη;',
