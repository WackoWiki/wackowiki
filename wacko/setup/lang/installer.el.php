...
"ModRewrite" => "Apache Rewrite Extension (Προεραιτικό)",
...
"Home" => "Αρχική Σελίδα",
"HomeDesc" => "Πληκτρολογήστε το όνομα που επιθυμείται να έχει η αρχική σελίδα σας, αυτή θα είναι η προκαθορισμένη σελίδα που θα βλέπουν οι χρήστες όταν επισκέφτονται το site σας και θα πρέπει να είναι ένα <a href=\"http://wackowiki.de/Archiv/DocEnglish/WikiName\" title=\"View Help\" target=\"_blank\">WikiName</a>.",
"MultiLang" => "Πολυγλωσική Υποστήριξη",
...
"ErrorInsertingPageWritePermission" => "Σφάλμα ρύθμισης δικαιώματατος εγγραφής για την %1 σελίδα",
...
"SecurityRisk" => "Σας προτείνεται να αφαιρέσετε το δικαιώμα εγγραφής στο <tt>wakka.config.php</tt> τώρα που έχει γραφτεί. Αφήνοντάς το αρχείο εγγράψιμο μπορεί να αποτελελεί ρίσκο ασφάλειας!",
