...
"ErrorMinPHPVersion" => "Η έκδοση της PHP πρέπει να είναι μεγαλύτερη της <strong>5.1.0</strong>, ο διακομιστής σας φαίνεται να τρέχει σε προηγούμενη έκδοση. Πρέπει να αναβαθμίσετε σε μία πιο πρόσφατη PHP έκδοση για δουλέψει σωστά το WackoWiki.",
