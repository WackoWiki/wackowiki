...
'OK' => 'OK',
'Problem' => 'Problema',
'NotePermissions' => 'El instalador intentará guardar los datos de configuración en el archivo <code>config.php</code>, ubicado en el directorio de WackoWiki. Para que pueda funcionar esto debe asegurarse que el servidor web tiene permiso de escritura para este archivo. Si no lo logra concederle, deberá editar el archivo manualmente (el instalador le dará indicaciones de como..).<br /><br />Véa <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a> por más detalles.',
...
'NameDesc' => 'Por favor ingrese el nombre de su sitio WackoWiki, lo debe escribir de manera <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">NombreWiki</a>.',
'Home' => 'Página de inicio',
'HomeDesc' => 'Ingrese el nombre de la página de inicio del sitio, esto será la página por defecto que los visitantes verán y debería ser escrito de manera <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">NombreWiki</a>.',
...
'AdminDesc' => 'Ingrese el nombre de usuario del administrador, esto debería escrito de manera <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">NombreWiki</a> (e.g. WikiAdmin).',
...
'Base' => 'URL Base',
'BaseDesc' => 'La URL base del sitio WackoWiki. Se adjuntan los nombres de lás páginas, y si está usando mod_rewrite, la dirección debería terminar con una barra i.e.</p><ul><li><strong><em>http://example.com/</em></strong></li><li><strong><em>http://example.com/wiki/</em></strong></li></ul>',
...
'ErrorInsertingPage' => 'Error al insertar <code>%1</code> página',
'ErrorInsertingPageReadPermission' => 'Error al establecer permisos de lectura para <code>%1</code> página',
'ErrorInsertingPageWritePermission' => 'Error al establecer permisos de escritura para <code>%1</code> página',
'ErrorInsertingPageCommentPermission' => 'Error al establecer permisos de comentario para <code>%1</code> página',
...
'ErrorPageAlreadyExists' => '<code>%1</code> página ya existe',
...
'SecurityRisk' => 'Le recomendamos remover el privilegio de escritura para el archivo <code>config.php</code> ya que ahora está guardado. Si el archivo permanece con privilegios de escritura, puede correr un riesgo de seguridad!',
'RemoveSetupDirectory' => 'Debería eliminar ahora el directorio "setup" ya que se finalizó la instalación.',
'ErrorGivePrivileges' => 'No fue posible guardar el archivo de configuración <code>config.php</code>. Debería dar temporalmente permisos al servidor web para el directorio de WackoWiki, o al menos un archivo en blanco llamado <code>config.php</code> (<code>touch config.php ; chmod 666 config.php</code>; no se olvide de remover los privilegios de escritura más adelante, ie <code>chmod 644 config.php</code>). Si por algun  motivo no lo logra hacer, debería copiar el texto abajo en un archivo nuevo, y guardarlo/subirlo como <code>config.php</code> al directorio de WackoWiki. Hecho esto el sitio WackoWiki debería funcionar. Si continúa con problemas, visite <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
'NextStep' => 'En el paso siguiente el instalador intentará guardar el archivo con las configuraciones actualizadas, <code>config.php</code>. Por favor asegurese que el servidor web tenga acceso de escritura al archivo, o lo tendrá que editar manualmente. Vea <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a> por detalles.',
'WrittenAt' => 'Guardado ',
