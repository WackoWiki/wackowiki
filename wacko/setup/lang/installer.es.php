...
'ErrorGivePrivileges' => 'No fue posible guardar el archivo de configuración <code>config.php</code>. Debería dar temporalmente permisos al servidor web para el directorio de WackoWiki, o al menos un archivo en blanco llamado <code>config.php</code> <br><code>touch config/config.php</code><br><code>chmod 666 config/config.php</code><br>; no se olvide de remover los privilegios de escritura más adelante, i.e. <code>chmod 644 config/config.php</code>.<br>Si por algun  motivo no lo logra hacer, debería copiar el texto abajo en un archivo nuevo, y guardarlo/subirlo como <code>config/config.php</code> al directorio de WackoWiki. Hecho esto el sitio WackoWiki debería funcionar. Si continúa con problemas, visite <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
