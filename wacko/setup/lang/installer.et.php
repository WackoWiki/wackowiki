...
'ErrorGivePrivileges' => 'Konfiguratsiooni faili <code>config.php</code> ei ole võimalik kirjutada. Sa pead andma oma veebi serverile ajutiselt kirjutamisõiguse kas oma WackoWiki kataloogile, või siis tühjale failile nimega  <code>config.php</code> (<code>touch config.php; chmod 666 config.php;</code> ara unusta hiljem kirjutamisõigust eemaldada, näiteks nii: <code>chmod 644 config/config.php</code>.<br>Kuid kui sa mingil põhjusel ei saa seda teha, siis pead sa allpool oleva teksti kopeerima uude faili ja siis salvestama ning uploadima selle nimega <code>config/config.php</code> WackoWiki kataloogi. Kui sa oled selle ära teinud, siis peaks su WackoWiki leht töötama. Kui ei tööta, siis mine aadressile <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
