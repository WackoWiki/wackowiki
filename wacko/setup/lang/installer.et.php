...
"OK" => "OK",
"Problem" => "Problem",
"NotePermissions" => "Üritatakse konfiguratsiooni andmeid kirjutada faili nimega  <tt>config.inc.php</tt>, mis asub sinu  WackoWiki kataloogis. Et see töötaks, pead sa olema kindel, et veebi serveril on kirjutamisõigused sellesse faili! Kui kirjutamisoigust ei ole, pead sa käsitsi seda faili muutma (installeerimise käigus üteldakse kuidas see käib).<br /><br />Vaata seda, et saada täpsemaid juhiseid: <a href=\"http://wackowiki.org/Doc/English/Installation\" target=\"_blank\">WackoWiki:Doc/English/Installation</a>.",
