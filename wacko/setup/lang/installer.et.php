...
'OK' => 'OK',
'Problem' => 'Problem',
'NotePermissions' => 'Üritatakse konfiguratsiooni andmeid kirjutada faili nimega  <code>config.php</code>, mis asub sinu  WackoWiki kataloogis. Et see töötaks, pead sa olema kindel, et veebi serveril on kirjutamisõigused sellesse faili! Kui kirjutamisoigust ei ole, pead sa käsitsi seda faili muutma (installeerimise käigus üteldakse kuidas see käib).<br /><br />Vaata seda, et saada täpsemaid juhiseid: <a href="http://wackowiki.sourceforge.net/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>.',
...
'Name' => 'Sinu WikiNimi',
'NameDesc' => 'Sinu WikiNimi. Tavaliselt see näeb valja NaguMidagiSellist või EesnimiPerekonnanimi. <a href="http://wackowiki.sourceforge.net/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiName</a>.',
'Home' => 'KoduLeht',
'HomeDesc' => 'Sinu WackoWiki kodulehe nimi. Peaks ka olema <a href="http://wackowiki.sourceforge.net/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiNimi</a>.',
...
'PasswordDesc' => 'Vali administraatorile parool (vähemalt 9 tähemärki)',
...
'SecurityRisk' => 'Soovitan sul eemaldada kirjutamisõigus  <code>config.php</code> failile. Kirjutamisõiguse allesjätmine on riskantne turvalisuse seisukohast!',
'RemoveSetupDirectory' => 'You should delete the "setup" directory now that the installation process has been completed.',
'ErrorGivePrivileges' => 'Konfiguratsiooni faili <code>%1</code> ei ole võimalik kirjutada. Sa pead andma oma veebi serverile ajutiselt kirjutamisõiguse kas oma WackoWiki kataloogile, või siis tühjale failile nimega  <code>config.php</code> (<code>touch config.php; chmod 666 config.php;</code> ara unusta hiljem kirjutamisõigust eemaldada, näiteks nii: <code>chmod 644 config.php</code>). Kuid kui sa mingil põhjusel ei saa seda teha, siis pead sa allpool oleva teksti kopeerima uude faili ja siis salvestama ning uploadima selle nimega <code>config.php</code> WackoWiki kataloogi. Kui sa oled selle ära teinud, siis peaks su WackoWiki leht töötama. Kui ei tööta, siis mine aadressile <a href="http://wackowiki.sourceforge.net/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
'NextStep' => 'Järgmisena üritatakse kirjutada täiendatud konfiguratsioonifaili, <code>config.php</code>. Palun veendu, et veebi serveril oleks faili kirjutamise õigused, vastasel korral pead sa seda käsitsi tegema. Uuesti, vaata täpsema info saamiseks siia: <a href="http://wackowiki.sourceforge.net/doc/Doc/English/Installation" target="_blank">WackoWiki:Dokumentatsioon/Installeerimine</a>.',
'WrittenAt' => 'kirjutan ',
