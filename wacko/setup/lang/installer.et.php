...
'Name' => 'Sinu WikiNimi',
'NameDesc' => 'Sinu WikiNimi. Tavaliselt see näeb valja NaguMidagiSellist või EesnimiPerekonnanimi. <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiName</a>.',
'Home' => 'KoduLeht',
'HomeDesc' => 'Sinu WackoWiki kodulehe nimi. Peaks ka olema <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiNimi</a>.',
...
'Admin' => 'Adminni nimi',
'AdminDesc' => 'Sisesta administraatori kasutajanimi. Peaks olema <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiNimi</a> (e.g. WikiAdmin).',
...
'ErrorGivePrivileges' => 'Konfiguratsiooni faili <code>config.php</code> ei ole võimalik kirjutada. Sa pead andma oma veebi serverile ajutiselt kirjutamisõiguse kas oma WackoWiki kataloogile, või siis tühjale failile nimega  <code>config.php</code> (<code>touch config.php; chmod 666 config.php;</code> ara unusta hiljem kirjutamisõigust eemaldada, näiteks nii: <code>chmod 644 config.php</code>). Kuid kui sa mingil põhjusel ei saa seda teha, siis pead sa allpool oleva teksti kopeerima uude faili ja siis salvestama ning uploadima selle nimega <code>config.php</code> WackoWiki kataloogi. Kui sa oled selle ära teinud, siis peaks su WackoWiki leht töötama. Kui ei tööta, siis mine aadressile <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
'NextStep' => 'Järgmisena üritatakse kirjutada täiendatud konfiguratsioonifaili, <code>config.php</code>. Palun veendu, et veebi serveril oleks faili kirjutamise õigused, vastasel korral pead sa seda käsitsi tegema. Uuesti, vaata täpsema info saamiseks siia: <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Dokumentatsioon/Installeerimine</a>.',
'WrittenAt' => 'kirjutan ',
