...
'FreshInstall' => 'Bienvenue à bord de WackoWiki, vous vous apprêtez à installer WackoWiki <tt>%1</tt>.  Les quelques pages qui suivent vous guideront dans le processus d&rsquo;installation.',
...
'Name' => 'Nom WackoWiki',
'NameDesc' => 'Choisissez le nom de votre site WackoWiki, ce doit être un <a href="http://wackowiki.org/Doc/Francophone/NomWiki" title="Voir l&rsquo;aide" target="_blank">Nom Wiki</a>.',
'Home' => 'Page d&rsquo;accueil',
'HomeDesc' => 'Choissez le nom de votre page d&rsquo;accueil. Ce doit être un <a href="http://wackowiki.org/Doc/Francophone/NomWiki" title="Voir l&rsquo;aide" target="_blank">NomWiki</a>.',
...
'AdminDesc' => 'Indiquez le nom de l&rsquo;administrateur, ce doit être un <a href="http://wackowiki.org/Doc/Francophone/NomWiki" title="Voir l&rsquo;aide" target="_blank">Nom Wiki</a> (e.g. WikiAdmin).',
'Password' => 'Mot de passe de l&rsquo;administrateur',
'PasswordDesc' => 'Choisissez un mot de passe d&rsquo;au moins 8 caractères pour l&rsquo;administrateur.',
...
'Base' => 'URL de base',
'BaseDesc' => 'URL de base de votre site WackoWiki. Les noms de page lui sont accolés, aussi doit-il se terminer par une barre oblique si vous utilisez l&rsquo;extension "mod_rewrite", exemples :<br/><tt>http://wackowiki.org/<br/>http://wackowiki.org/wiki/</tt><br/>',
...
'ErrorAdminPasswordShort' => 'Le mot de passe de l&rsquo;administrateur est trop court, il doit avoir au moins 8 caractères !',
