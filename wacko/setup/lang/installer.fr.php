...
'PleaseUpgradeToR5' => 'Vous faites fonctionner une vieille version de WackoWiki, antérieure à la %1. Pour la mettre à jour à la version actuelle, vous devez d&rsquo;abord effectuer une mise à jour à la version <code class="version">%2</code>.',
...
'HomePageDesc' => 'Choissez le nom de votre page d&rsquo;accueil. Ce doit être un <a href="https://wackowiki.org/doc/Doc/Français/NomWiki" title="Voir l&rsquo;aide" target="_blank">NomWiki</a>.',
...
'AdminDesc' => 'Indiquez le nom de l&rsquo;administrateur, ce doit être un <a href="https://wackowiki.org/doc/Doc/Français/NomWiki" title="Voir l&rsquo;aide" target="_blank">Nom Wiki</a> (e.g. <code>WikiAdmin</code>).',
