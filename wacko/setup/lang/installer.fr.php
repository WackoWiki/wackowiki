...
'OK' => 'OK',
'Problem' => 'Problème',
'NotePermissions' => 'Cet installeur va tenter d&rsquo;écrire les données de configuration dans le fichier <code>config.php</code>, dans votre répertoire WackoWiki. Pour cela assurez-vous que le serveur http ait le droit d&rsquo;écrire dans ce répertoire.  Sinon, vous devrez éditer ce fichier manuellement ; l&rsquo;installeur vous indiquera comment faire.<br /><br />Voir <a href="https://wackowiki.sourceforge.io/doc/Doc/Francophone/InstallationEtMiseAJour" target="_blank">WackoWiki:Doc/Francophone/InstallationEtMiseAJour</a> pour les détails.',
...
'Name' => 'Nom WackoWiki',
'NameDesc' => 'Choisissez le nom de votre site WackoWiki, ce doit être un <a href="https://wackowiki.sourceforge.io/doc/Doc/Francophone/NomWiki" title="Voir l&rsquo;aide" target="_blank">Nom Wiki</a>.',
'Home' => 'Page d&rsquo;accueil',
'HomeDesc' => 'Choissez le nom de votre page d&rsquo;accueil. Ce doit être un <a href="https://wackowiki.sourceforge.io/doc/Doc/Francophone/NomWiki" title="Voir l&rsquo;aide" target="_blank">NomWiki</a>.',
...
'AdminDesc' => 'Indiquez le nom de l&rsquo;administrateur, ce doit être un <a href="https://wackowiki.sourceforge.io/doc/Doc/Francophone/NomWiki" title="Voir l&rsquo;aide" target="_blank">Nom Wiki</a> (e.g. WikiAdmin).',
...
'UpdateTable' => 'Mise à jour de la table <code>%1</code>',
...
'ErrorInsertingPageWritePermission' => 'Erreur lors de l&rsquo;attribution du droit d&rsquo;écrire la page <code>%1</code>',
...
'ErrorInsertingDefaultMenuItem' => 'Erreur de paramétrage de la page <code>%1</code> come élément de menu par défaut',
'ErrorPageAlreadyExists' => 'La page <code>%1</code> existe déjà',
...
'ErrorUpdatingTable' => 'Erreur lors de la mise à jour de la table <code>%1</code>',
'CreatingTable' => 'Création de la table <code>%1</code>',
'ErrorAlreadyExists' => ' Erreur, <code>%1</code> existe déjà',
'ErrorCreatingTable' => 'Erreur lors de la création de la table <code>%1</code>, existe-telle déjà ?',
...
'SecurityRisk' => 'Par sécurité, limitez maintenant le droit d&rsquo;écrire le fichier <code>config.php</code> maintenant, par exemple <code>chmod 644 config.php</code>.',
'RemoveSetupDirectory' => 'Par sécurité, supprimez maintenant le répertoire "setup", devenu inutile.',
'ErrorGivePrivileges' => 'Le fichier de configuration <code>config.php</code> n&rsquo;a pas pu être écrit par le serveur http dans votre répertoire WackoWiki.<br/>Si possible, créez un fichier vide appelé  <code>config.php</code>, sur lequel vous attribuerez à provisoirement à tous le droit d&rsquo;écrire :<br/><code>touch config.php</code><br/><code>chmod 666 config.php</code>.<br/>Nota : après enregistrement vous supprimerez ce droit, i.e. <code>chmod 644 config.php</code>).<br/> Sinon, vous devrez copier le texte ci-dessous dans un fichier et le sauvegarder comme <code>config.php</code> dans le répertoire WackoWiki.<br/>Ceci fait, votre site WackoWiki devrait fonctionner. Sinon, voyez  <a href="https://wackowiki.sourceforge.io/doc/Doc/Francophone/InstallationEtMiseAJour">WackoWiki:Doc/Francophone/InstallationEtMiseAJour</a>',
'NextStep' => 'Au cours de la prochaine étape, l&rsquo;installeur va tenter d&rsquo;écrire le fichier de configuration mis à jour, <code>config.php</code>.  Assurez-vous que le serveur ait le droit d&rsquo;écrire ce fichier, sinon vous devrez l&rsquo;éditer manuellement. Encore une fois, voyez <a href="https://wackowiki.sourceforge.io/doc/Doc/Francophone/InstallationEtMiseAJour" target="_blank">WackoWiki:Doc/Francophone/InstallationEtMiseAJour</a> pour les détails.',
'WrittenAt' => 'écrit à ',
'DontChange' => 'ne modifiez pas le paramètre « wacko_version » !',
'ConfigDescription' => 'pour une description détaillée de la configuration voir https://wackowiki.sourceforge.io/doc/Doc/Francophone/Configuration',
