...
'OK' => 'OK',
'Problem' => 'Problem',
'NotePermissions' => 'Questo installatore  tenterà di scrivere i dati di configurazione nel file <code>config.php</code>, presente nella tua directory WackoWiki. Per gestire al meglio questa operazione, devi assicurarti che il server del tuo sito sia accessibile alla scrittura per questo file! Se non puoi farlo, dovrai editare il file manualmente (l\'installatore ti dirà come farlo).<br /><br />Vedi <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a> per i dettagli.',
...
'NameDesc' => 'Il nome del tuo sito WackoWiki. È di norma un NomeWiki e somiglia a QualcosaComeQuesto. <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiName</a>.',
'Home' => 'Home Page',
'HomeDesc' => 'La tua homepage WackoWiki. Deve essere un <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">NomeWiki</a>.',
...
'AdminDesc' => 'Immetti username dell\'amministratore (dovrà essere un <a href="https://wackowiki.sourceforge.io/doc/Doc/English/WikiName" title="View Help" target="_blank">WikiName</a>) (e.g. WikiAdmin).',
...
'SecurityRisk' => 'Infine, ti consigliamo di escludere l\'opzione di scrittura su <code>config.php</code>ora che è stata scritta. Lasciare il file aperto alla scrittura è un rischio per la tua sicurezza!',
'RemoveSetupDirectory' => 'You should delete the "setup" directory now that the installation process has been completed.',
'ErrorGivePrivileges' => 'Il file di configurazione <code>config.php</code> non si è potuto scrivere. Si dovrà rendere temporaneamente accessibile alla scrittura il tuo server e la tua directory WackoWiki, o un file vuoto col nome di <code>config.php</code> (<code>touch config.php ; chmod 666 config.php</code>; don\'t forget to remove write access again later, ie <code>chmod 644 config.php</code>). Se, per qualche motivo, non puoi farlo, dovrai copiare il testo in basso in un nuovo file e salvarlo/immetterlo come <code>config.php</code> nella directory WackoWiki. Ciò fatto, il tuo sito WackoWiki è pronto per funzionare. Altrimenti, visita <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
'NextStep' => 'Nel passo successivo, l\'installatore tenterà di scrivere il nuovo file di configurazione, <code>config.php</code>. Verifica che il server del web abbia accesso alla scrittura sul file, o che tu possa editarlo manualmente.  Ancora una volta, consulta  <a href="https://wackowiki.sourceforge.io/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a> per i dettagli.',
'WrittenAt' => 'scritto a ',
