...
"OK" => "OK",
"Problem" => "Problem",
"NotePermissions" => "Questo installatore  tenterà di scrivere i dati di configurazione nel file <tt>config.inc.php</tt>, presente nella tua directory WackoWiki. Per gestire al meglio questa operazione, devi assicurarti che il server del tuo sito sia accessibile alla scrittura per questo file! Se non puoi farlo, dovrai editare il file manualmente (l'installatore ti dirà come farlo).<br /><br />Vedi <a href=\"http://wackowiki.org/Doc/English/Installation\" target=\"_blank\">WackoWiki:Doc/English/Installation</a> per i dettagli.",
...
"AdminDesc" => "Immetti username dell'amministratore (dovrà essere un <a href=\"http://wackowiki.org/Doc/English/WikiName\" title=\"View Help\" target=\"_blank\">WikiName</a>) .",
...
"CleanupScript" => "Se utilizzi <a href=\"http://wackowiki.org/Doc/English/CleanupScript\" target=\"_blank\">WackoWiki:Doc/English/CleanupScript</a>, renderai più veloce il tuo Wacko.",
...
"InstallationComplete" => "È tutto! Adesso puoi <a href=\"%1\">view your WackoWiki site</a>.",
"SecurityConsiderations" => "Security Considerations",
"SecurityRisk" => "Infine, ti consigliamo di escludere l'opzione di scrittura su <tt>config.inc.php</tt>ora che è stata scritta. Lasciare il file aperto alla scrittura è un rischio per la tua sicurezza!",
"RemoveSetupDirectory" => "You should delete the \"setup\" directory now that the installation process has been completed.",
"ErrorGivePrivileges" => "Il file di configurazione <tt>%1</tt> non si è potuto scrivere. Si dovrà rendere temporaneamente accessibile alla scrittura il tuo server e la tua directory WackoWiki, o un file vuoto col nome di <tt>config.inc.php</tt> (<tt>touch config.inc.php ; chmod 666 config.inc.php</tt>; don't forget to remove write access again later, ie <tt>chmod 644 config.inc.php</tt>). Se, per qualche motivo, non puoi farlo, dovrai copiare il testo in basso in un nuovo file e salvarlo/immetterlo come <tt>config.inc.php</tt> nella directory WackoWiki. Ciò fatto, il tuo sito WackoWiki è pronto per funzionare. Altrimenti, visita <a href=\"http://wackowiki.org/Doc/English/Installation\" target=\"_blank\">WackoWiki:Doc/English/Installation</a>",
"NextStep" => "Nel passo successivo, l'installatore tenterà di scrivere il nuovo file di configurazione, <tt>config.inc.php</tt>. Verifica che il server del web abbia accesso alla scrittura sul file, o che tu possa editarlo manualmente.  Ancora una volta, consulta  <a href=\"http://wackowiki.org/Doc/English/Installation\" target=\"_blank\">WackoWiki:Doc/English/Installation</a> per i dettagli.",
"WrittenAt" => "scritto a ",
