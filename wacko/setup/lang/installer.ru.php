...
"ErrorMinPHPVersion" => "Версия PHP должна быть больше <strong>5.1.0</strong>, а сервер использует одну из предыдущих версий.  Для корректной работы WackoWiki нужно обновить PHP на одну из последних версий.",
...
"Admin" => "Admin Name",
"AdminDesc" => "Выберите имя администратора. Должно представлять собой ВикиИмя (без русских букв) <a href=\"http://wackowiki.org/Doc/English/WikiName\" title=\"View Help\" target=\"_blank\">WikiName</a> (e.g. WikiAdmin).",
...
"DBPassword" => "Пароль",
"PrefixDesc" => "Префикс всех таблиц, используемых WackoWiki. Это позволит запускать несколько WackoWiki, используя одну БД&nbsp;&mdash;&nbsp;достаточно указать для них разные префиксы таблиц (e.g. wacko_).",
