...
"NameDesc" => "Имя вашей Ваки. Обычно представляет собой ВикиИмя и выглядит ПримерноВотТак. <a href=\"http://wackowiki.org/Doc/English/WikiName\" title=\"View Help\" target=\"_blank\">WikiName</a>.",
...
"CleanupScript" => "Попробуйте <a href=\"http://wackowiki.org/Doc/English/CleanupScript\" target=\"_blank\">WackoWiki:Doc/English/CleanupScript</a>, это ускорит вашу Ваку.",
