...
'OK' => 'OK',
'Problem' => 'Проблема',
'NotePermissions' => 'Программа установки попытается записать настройки в файл <code>config.php</code>, расположенный в каталоге WackoWiki. Чтобы всё прошло успешно, убедитесь, что веб-сервер имеет право на запись в данный файл. Если это невозможно, вам придётся изменить файл вручную (программа установки объяснит, как).<br /><br />См. <a href="https://wackowiki.org/doc/Doc/Russian/Installjacija" target="_blank">WackoWiki:Doc/Russian/Инсталляция</a>.',
...
'AllowedLangDesc' => 'Рекомендуется выбрать набор языков, который вы действительно будете использовать, иначе будут выбраны все.',
