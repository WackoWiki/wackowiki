...
'OK' => 'OK',
'Problem' => 'Проблема',
'NotePermissions' => 'Программа установки попытается записать настройки в файл <code>config.php</code>, расположеный в каталоге WackoWiki. Чтобы всё прошло успешно, убедитесь, что веб-сервер имеет право на запись в данный файл. Если это невозможно, вам придётся изменить файл вручную (программа установки объяснит, как).<br /><br />См. <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:DocEnglish/Installation</a>.',
...
'NameDesc' => 'Пожалуйста, введите имя вашего сайта WackoWiki, оно должно быть <a href="https://wackowiki.org/doc/Doc/English/WikiName" title="View Help" target="_blank">ВикиИменем</a>.',
'Home' => 'Главная страница',
'HomeDesc' => 'Введите имя домашней страницы&nbsp;&mdash; это будет страница по умолчанию, пользователи увидят её первой при посещении сайта; имя должно <a href="https://wackowiki.org/doc/Doc/English/WikiName" title="View Help" target="_blank">ВикиИменем</a>.',
...
'ErrorGivePrivileges' => 'Конфигурационный файл <code>config.php</code> не может быть сохранён. Нужно временно дать веб-серверу права на запись либо на каталог WackoWiki, либо на пустой файл <code>config.php</code> (<code>touch config.php ; chmod 666 config.php</code>; не забудьте убрать эти права после установки, т.&nbsp;e. <code>chmod 644 config.php</code>). Если, почему-либо вы не можете выставить такие права, придётся скопировать текст, расположенный ниже в новый файл и загрузить его на сервер под именем <code>config.php</code> в каталог WackoWiki. После этого ваш сайт должен заработать. Если нет, смотрите <a href="https://wackowiki.org/doc/Doc/English/Installation">WackoWiki:DocEnglish/Installation</a>',
'NextStep' => 'На следующем шаге программа установки попробует сохранить обновлённый конфигурационный файл, <code>config.php</code>. Пожалуйста, проверьте, что веб-сервер имеет достаточно прав для изменения файла; в противном случае вам придётся сохранить изменения вручную. Не побоимся повториться, см. <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:DocEnglish/Installation</a>.',
'WrittenAt' => 'сохранён ',
