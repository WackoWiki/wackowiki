...
"OK" => "OK",
"Problem" => "Проблема",
"NotePermissions" => "Программа установки попытается записать настройки в файл <tt>wakka.config.php</tt>, расположеный в каталоге WackoWiki. Чтобы всё прошло успешно, убедитесь, что веб-сервер имеет право на запись в данный файл. Если это невозможно, вам придётся изменить файл вручную (программа установки объяснит, как).<br /><br />См. <a href=\"http://wackowiki.org/Doc/English/Installation\" target=\"_blank\">WackoWiki:DocEnglish/Installation</a>.",
...
"DBUserDesc" => "Имя пользователя и пароль для подключения к базе данных.",
"DBUser" => "Имя пользователя",
"DBPasswordDesc" => "Имя пользователя и пароль для подключения к базе данных.",
"DBPassword" => "Пароль",
"PrefixDesc" => "Префикс всех таблиц, используемых WackoWiki. Это позволит запускать несколько WackoWiki, используя одну БД&nbsp;&mdash;&nbsp;достаточно указать для них различные префиксы.",
...
"ErrorInsertingPageReadPermission" => "Ошибка установки прав на чтение страницы %1",
"ErrorInsertingPageWritePermission" => "Ошибка установки прав на запись страницы %1",
"ErrorInsertingPageCommentPermission" => "Ошибка установки прав на комментирование страницы %1",
...
"SecurityRisk" => "Не забудьте убрать права на изменение файла <tt>wakka.config.php</tt> веб-сервером. Если этого не сделать, вас смогут взломать!",
"RemoveSetupDirectory" => "Сейчас вы должны удалить каталог \"setup\";&nbsp;&mdash;&nbsp;процесс установки завершён.",
"ErrorGivePrivileges" => "Конфигурационный файл %1 не может быть сохранён. Нужно временно дать веб-серверу права на запись либо на каталог WackoWiki, либо на пустой файл <tt>wakka.config.php</tt> (<tt>touch wakka.config.php ; chmod 666 wakka.config.php</tt>; не забудьте убрать эти права после установки, т. e. <tt>chmod 644 wakka.config.php</tt>). Если, почему-либо вы не можете выставить такие права, придётся скопировать текст, расположенный ниже в новый файл и загрузить его на сервер под именем <tt>wakka.config.php</tt> в каталог WackoWiki. После этого ваш сайт должен заработать. Если нет, смотрите <a href=\"http://wackowiki.org/Doc/English/Installation\">WackoWiki:DocEnglish/Installation</a>",
