...
*/
'lang' => 'Выбор языка',
'PleaseUpgradeToR5' => 'Вы используете доисторическую (до %1) версию WackoWiki. Для обновления до текущей версии сперва необходим отдельный апгрейд до <code class="version">%2</code>.',
...
'HomePageDesc' => 'Введите имя домашней страницы — это будет страница по умолчанию, пользователи увидят её первой при посещении сайта; имя должно <a href="https://wackowiki.org/doc/Doc/Russian/ВикиИмя" title="View Help" target="_blank">ВикиИменем</a>.',
...
'AdminDesc' => 'Введите имя администратора, оно должно быть <a href="https://wackowiki.org/doc/Doc/Russian/ВикиИмя" title="View Help" target="_blank">ВикиИменем</a> (без русских букв) (например, <code>WikiAdmin</code>).',
...
'ConfigDescription' => 'подробное описание https://wackowiki.org/doc/Doc/Russian/ФайлКонфигурации',
