...
*/
'lang'							=> '语言设置',
'PleaseUpgradeToR6'				=> '你正在运行一个旧版本(前 %1)。 若要更新到 当前版本，您必须先更新您的安装包到 %2。',
...
'NotePermissions'				=> '此安装程序将尝试将配置数据写入你的WackoWiki 目录中的文件 %1。 为了使此文件生效，您必须确保网页服务器能够写入该文件。 如果您不能这样做，您将需要手动编辑文件 (安装程序将告诉您如何操作)。<br><br>详情请参阅 <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
...
'ErrorGivePrivileges'			=> '无法写入配置文件 %1 。 您需要给予您的 web 服务器临时写入访问您的 WackoWiki 目录的权限。 或者一个名为 %1的空白文件<br>%2<br>; 不要忘记在稍后再次移除写入权限。 . %3.<br>如果出于任何原因你不能这样做， 您必须将下面的文本复制到一个新文件并保存/上传为 %1 到 WackoWiki 目录。 一旦你完成了这个操作，你的 WackoWiki 网站应该正常工作。如果没有，请访问 <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
'NextStep'						=> '此安装程序将尝试将配置数据写入你的WackoWiki 目录中的文件 %1。 为了使此文件生效，您必须确保网页服务器能够写入该文件。 如果您不能这样做，您将需要手动编辑文件 (安装程序将告诉您如何操作)。<br><br>详情请参阅 <a href="https://wackowiki.org/doc/Doc/English/Installation" target="_blank">WackoWiki:Doc/English/Installation</a>',
'WrittenAt'						=> '写入 ',
