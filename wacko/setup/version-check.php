...
<ul>
	...
	$file_permissions_result = is_writable('config/config.php') && is_writable('_cache/config/') && is_writable('_cache/feeds/') && is_writable('_cache/pages/') && is_writable('_cache/queries/') && is_writable('xml/') && is_writable('files/global/') && is_writable('files/perpage/') && is_writable('sitemap.xml');
	?>
