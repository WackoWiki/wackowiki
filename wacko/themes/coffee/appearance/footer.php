...
if ($this->page)
{
	...
	{
		// Page  settings link
		print("<li><a href=\"".$this->href("properties"). "\"".(($this->method=='edit')?" onclick=\"return window.confirm('".$this->GetTranslation("EditPropertiesConfirm")."');\"":"").">".$this->GetTranslation("PropertiesText")."</a></li>\n");
