...
<div class="TopRight"><?php echo $this->FormOpen("", $this->GetResourceValue("TextSearchPage"), "get"); ?>

<span class="nobr"> <?php echo $this->ComposeLinkToPage($this->GetConfigValue("root_page")) ?>&nbsp;|&nbsp;
<?php echo $this->Format($this->GetDefaultBookmarks($this->userlang, "site")) ?></span>
| <?php echo $this->GetResourceValue("SearchText") ?><input
	name="phrase" size="15" class="ShSearch" /> <?php echo $this->FormClose(); ?>
</div>
<div class="TopLeft"><?php if ($this->GetUser()) { ?> <img
	src="<?php echo $this->GetConfigValue("theme_url") ?>icons/role.gif"
	hspace="5" vspace="5" width="9" height="15" alt="" /><span class="nobr"><?php echo $this->GetResourceValue("YouAre")." ".$this->Link($this->GetUserName()) ?></span>
...
| <a
	...
	href="<?php echo $this->Href("","Login").($this->config["rewrite_mode"] ? "?" : "&amp;");?>action=logout&amp;goback=<?php echo $this->SlimUrl($this->tag);?>"><?php echo $this->GetResourceValue("LogoutLink"); ?></a></span>
)</small> <?php } else { ?>
...
<?php echo $this->FormOpen("", "Login", "post"); ?>
	...
	<tr>
		...
		<td>&nbsp;&nbsp;&nbsp;<?php echo $this->GetResourceValue("LoginPassword") ?>:&nbsp;
		</td>
		<td><input type="hidden" name="goback"
			value="<?php echo $this->SlimUrl($this->tag);?>" /> <input
			type="password" name="password" size="8" />&nbsp;</td>
...
<div class="Print"><?php if ($this->GetUser()) { ?> <?php echo ($this->IsWatched($this->GetUserName(), $this->GetPageTag()) ?
...
<div class="header">
<h1><span class="Main"><?php echo $this->config["wakka_name"] ?>:</span>
<?php echo $this->GetPagePath(); ?> <a class="Search"
