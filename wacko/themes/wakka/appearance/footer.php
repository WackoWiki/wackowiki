...
if ($this->page)
{
	if ($this->has_access('read'))
	{
		...
		if ($this->user_is_owner())
		{
			...
			(($this->method == 'new')
				? ""
				: print("<li><a href=\"".$this->href('new')."\"><img src=\"".$this->config['theme_url']."icons/add_page.png\" title=\"".$this->get_translation('CreateNewPageTip')."\" alt=\"".$this->get_translation('CreateNewPageTip')."\" /></a></li>\n")
			);
